...
class ReserveSummary(SalesInvBase):
    ...
    def __init__(self,fsClient, **kwargs):
        ...
        base = "[*].{id: id, reserve_date: reserve_date, customer: customer.name, customer_id: customer.id, location: location.name, location_id: location.id, num_reserved: num_reserved, item_name: item.name, item_id: item.id "
