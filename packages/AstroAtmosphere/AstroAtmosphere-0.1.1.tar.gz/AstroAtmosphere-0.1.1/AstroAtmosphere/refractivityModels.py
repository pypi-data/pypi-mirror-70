...
def BarrellAndSears(l, T=288.15, p=101325, H=0):
	'''
		...
		H - fractional humidity (0=<H=<1)

		Returns:
		n - Refractive index of atmospheric air at the given conditions
	'''
	T = K2C(T)
	P = hPA2mmHg(p/100)
...
def BonschPotulski(l, T=288.15, p=101325, CO2=450):
	'''
		...
		T - Temperature in Kelvin
		p - Atmospheric pressure in Pa
		CO2 - Particles per million of CO2
...
def slalib(l, T=288.15, p=101325, H=0, h=0, lat=-24, tlr=0.0065, eps=1e-10):
	'''
		...
		p - Atmospheric pressure in Pa
		H - fractional humidity (0=<H=<1)
		h - Altitude of the observer (default=0 m)
		lat - Latitude of the observer (default=-24)
		tlr - temperature lapse rate (default=0.0065)
		eps - precision at which the calculation is aborted (default=1e-10)
