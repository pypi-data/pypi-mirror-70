...
class DKRecipeDisk:
    ...
    def write_recipe_state(self, recipe_dir: str,
                           remote_shas: Optional[JSONData] = None) -> Optional[bool]:
    ...
    @staticmethod
    def _find_recipe(walk_dir: Optional[str] = None,
                     return_recipe_root_path: bool = False) -> Optional[str]:
