...
class TBoxBase(object):
    ...
    def __init__(self, script_path, pepper_key_fp=None):
        """
...
class Toolbox(TBoxBase, LogHandle, SQLQueue):
    def __init__(self, script_path, pepper_key_fp=None, logging_dir=None, logging_base_name=None, max_pool_size=None,
                 *args, **kwargs):
        ...
        TBoxBase.__init__(self, script_path=script_path, pepper_key_fp=pepper_key_fp)
