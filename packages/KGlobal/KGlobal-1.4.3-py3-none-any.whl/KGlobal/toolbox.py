...
class TBoxBase(object):
    ...
    def __init__(self, script_path):
        ...
        if not (os.path.exists(salt_key_fp) and os.path.exists(pepper_key_fp)) or not os.path.exists(key_ptr_fp):
    ...
    def __new_pointer(self, pointer=None, old_db_path=None):
        ...
        obj = SetupGUI(local_db_dir=self.__base_dir, pointer=pointer, main_db_path=old_db_path)
