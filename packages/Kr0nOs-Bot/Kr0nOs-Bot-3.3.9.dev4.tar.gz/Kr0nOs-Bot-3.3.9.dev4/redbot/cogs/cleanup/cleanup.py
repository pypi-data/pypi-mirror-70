...
class Cleanup(commands.Cog):
    ...
    async def text(
        self, ctx: commands.Context, text: str, number: int = 20, delete_pinned: bool = False
    ):
        ...
        try:
            ...
            return await ctx.send("Purge in progress man, chill tf out.")
    ...
    @commands.bot_has_permissions(manage_messages=True)
    async def user(
        self, ctx: commands.Context, user: str, number: int = 20, delete_pinned: bool = False
    ):
    ...
    @commands.guild_only()
    @commands.bot_has_permissions(manage_messages=True)
    async def messages(self, ctx: commands.Context, number: int = 20, delete_pinned: bool = False):
    ...
    async def cleanup_bot(
        self, ctx: commands.Context, number: int = 20, delete_pinned: bool = False
    ):
