...
class MuteMixin(MixinMeta):
    ...
    async def hmute(self, ctx: commands.Context):
        """Mute users."""
        pass

    @hmute.command(name="voice")
    @commands.guild_only()
    ...
    @hmute.command(name="server", aliases=["guild"])
    @commands.guild_only()
    @commands.bot_has_permissions(manage_roles=True)
    @checks.mod_or_permissions(administrator=True)
    ...
    @commands.bot_has_permissions(manage_roles=True)
    @checks.mod_or_permissions(manage_channels=True)
    async def hunmute(self, ctx: commands.Context):
        """Unmute users."""
        pass

    @hunmute.command(name="voice")
    @commands.guild_only()
    ...
    @checks.mod_or_permissions(administrator=True)
    @hunmute.command(name="server", aliases=["guild"])
    @commands.bot_has_permissions(manage_roles=True)
    @commands.guild_only()
