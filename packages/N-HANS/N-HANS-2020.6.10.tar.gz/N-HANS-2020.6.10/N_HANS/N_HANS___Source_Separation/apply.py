...
def recover_samples_from_spectrum(logspectrum_stft, spectrum_phase, save_to):
    ...
    with istft_graph.as_default():
        ...
        samples = tf.contrib.signal.inverse_stft(stft_ph, 400, 160, 400, window_fn=tf.signal.inverse_stft_window_fn(160, forward_window_fn=functools.partial(tf.signal.hann_window, periodic=True)))
