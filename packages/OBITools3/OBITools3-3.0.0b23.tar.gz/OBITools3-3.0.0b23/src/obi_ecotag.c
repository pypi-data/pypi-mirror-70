...
int print_assignment_result(Obiview_p output_view, index_t line,
							...
							OBIDMS_column_p best_match_taxids_column, const char* best_match_taxids, int best_match_taxids_length,
			   ...
			   double ecotag_threshold)    // TODO different threshold for the similarity sphere around ref seqs
{
	...
	int32_t         best_match_taxids_length;
...
//					}
		...
		if (print_assignment_result(output_view, i,
									...
									best_match_taxids_column, best_match_taxids_to_store, best_match_taxids_length,
