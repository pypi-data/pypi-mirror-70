        ...
        while True:
            ...
            if robot_message is not None:
                ...
                if robot_message_json["message_type"] == "serial_message":
                    serial_config = json.loads(robot_message_json["serial_message"])
                    serial_conn = Serial(serial_config["port"], serial_config["rate"], serial_config["size"])
                    serial_conn.write(serial_config["content"])
                    if serial_config["switch"] :
