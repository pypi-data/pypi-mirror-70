...
class InvalidState(RobotRaconteurException):
    def __init__(self,message="",subname=None,param_=None):
        super(InvalidState,self).__init__(RobotRaconteurPython.MessageErrorType_InvalidState, "RobotRaconteur.InvalidState",message,subname,param_)
...
class RobotRaconteurExceptionUtil:
    ...
    def ErrorCodeToException(code,name,errstr,subname,param_):
        ...
        if (code==RobotRaconteurPython.MessageErrorType_InvalidState):
            return InvalidState(errstr,subname,param2)
