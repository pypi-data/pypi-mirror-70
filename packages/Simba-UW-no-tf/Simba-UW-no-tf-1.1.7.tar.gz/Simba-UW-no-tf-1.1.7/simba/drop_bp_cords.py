...
def bodypartConfSchematic():
    ...
    optionsBaseListImagesPath = os.path.join(dirname, 'pose_configurations', 'schematics')
    optionsBaseListNamesPath = os.path.join(dirname, 'pose_configurations', 'configuration_names', 'pose_config_names.csv')
