...
Another app state event gets fired after the app states getting
retrieved from the app class instance and before they get saved.
This event has the method name :meth:`on_app_states_save` and
provides one event argument `app_states` which is a dict of
type :data:`AppStateType` containing all app states.
...
class MainAppBase(ConsoleApp, ABC):
    ...
    def save_app_states(self) -> str:
        ...
        self.call_method('on_app_states_save', app_state)
