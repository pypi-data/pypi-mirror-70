...
@click.option("--restricted_organisation", default=None, multiple=True)
@click.pass_context
def add_client(ctx, restricted_organisation, **kwargs):
    output_entry(
        issuers.add_client(
            ctx, restricted_organisations=restricted_organisation, **kwargs
        )
    )
...
@click.option("--restricted_organisation", default=None, multiple=True)
@click.pass_context
def update_client(ctx, restricted_organisation, **kwargs):
    output_entry(
