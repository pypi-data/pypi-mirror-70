/*! For license information please see chunk.4507347f036cdffd580e.js.LICENSE */
...
`;r.setAttribute("style","display: none;"),document.head.appendChild(r.content)},266:function(e,t,i){"use strict";var r=i(4),n=i(31),o=i(216),a=i(217);i(276);customElements.define("ha-call-service-button",class extends(Object(a.a)(n.a)){static get template(){return r.a`
    ...
    `}}]}},r.a)},368:function(e,t,i){"use strict";i.d(t,"a",function(){return r});const r=e=>{let t=function(e){const t=e.split(":").map(Number);return 3600*t[0]+60*t[1]+t[2]}(e.attributes.remaining);if("active"===e.state){const i=(new Date).getTime(),r=new Date(e.last_changed).getTime();t=Math.max(t-(i-r)/1e3,0)}return t}},491:function(e,t,i){"use strict";i.d(t,"a",function(){return r});const r=e=>e.callWS({type:"webhook/list"})},770:function(e,t,i){"use strict";i.r(t);i(255),i(178);var r=i(4),n=i(31);i(180),i(118),i(345),i(221),i(148),i(145),i(136),i(266),i(128);customElements.define("ha-config-ais-dom-config-logs",class extends n.a{static get template(){return r.a`
...
//# sourceMappingURL=chunk.4507347f036cdffd580e.js.map