...
Common Variables: omega, delta, tm, te, vf, XadIfd, vd, vq, Id, Iq
...
+===========+========+=======+============================+=================+
|  vf_lower |        | 1.500 | lower limit for vf warning |                 |
+-----------+--------+-------+----------------------------+-----------------+
...
+---------+-------------------------+----------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
|  Se     | :math:`S_e(|\psi_{a}|)` | Algeb    | :math:`\frac{S_{B} z_{0}^{SL} \left(- S_{A} + \psi_a\right)^{2}}{\psi_a} - S_e(|\psi_{a}|)`                                                                                       |
+---------+-------------------------+----------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
+----------------+----------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------+
|  Se0           | :math:`S_{e0}`             | :math:`\frac{S_{B} \left(- S_{A} + |\psi''_0|\right)^{2} \left(|\psi''_0| \geq S_{A}\right)}{|\psi''_0|}`                                                          | ConstService |
+----------------+----------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------+
