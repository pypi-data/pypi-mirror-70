...
class Trail(aws_cdk.core.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-cloudtrail.Trail"):
    ...
    :stability: experimental
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, bucket: typing.Optional[aws_cdk.aws_s3.IBucket]=None, cloud_watch_log_group: typing.Optional[aws_cdk.aws_logs.ILogGroup]=None, cloud_watch_logs_retention: typing.Optional[aws_cdk.aws_logs.RetentionDays]=None, enable_file_validation: typing.Optional[bool]=None, include_global_service_events: typing.Optional[bool]=None, is_multi_region_trail: typing.Optional[bool]=None, kms_key: typing.Optional[aws_cdk.aws_kms.IKey]=None, management_events: typing.Optional["ReadWriteType"]=None, s3_key_prefix: typing.Optional[str]=None, send_to_cloud_watch_logs: typing.Optional[bool]=None, sns_topic: typing.Optional[aws_cdk.aws_sns.ITopic]=None, trail_name: typing.Optional[str]=None) -> None:
        """
        :param scope: -
        :param id: -
...
class TrailProps():
    def __init__(self, *, bucket: typing.Optional[aws_cdk.aws_s3.IBucket]=None, cloud_watch_log_group: typing.Optional[aws_cdk.aws_logs.ILogGroup]=None, cloud_watch_logs_retention: typing.Optional[aws_cdk.aws_logs.RetentionDays]=None, enable_file_validation: typing.Optional[bool]=None, include_global_service_events: typing.Optional[bool]=None, is_multi_region_trail: typing.Optional[bool]=None, kms_key: typing.Optional[aws_cdk.aws_kms.IKey]=None, management_events: typing.Optional["ReadWriteType"]=None, s3_key_prefix: typing.Optional[str]=None, send_to_cloud_watch_logs: typing.Optional[bool]=None, sns_topic: typing.Optional[aws_cdk.aws_sns.ITopic]=None, trail_name: typing.Optional[str]=None) -> None:
