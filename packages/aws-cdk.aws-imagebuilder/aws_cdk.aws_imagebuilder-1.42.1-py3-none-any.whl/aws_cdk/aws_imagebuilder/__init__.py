...
class CfnImage(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-imagebuilder.CfnImage"):
    ...
    @builtins.property
    @jsii.member(jsii_name="attrOutputResources")
    def attr_output_resources(self) -> typing.List[str]:
        """
        cloudformationAttribute:
        :cloudformationAttribute:: OutputResources
        """
        return jsii.get(self, "attrOutputResources")
...
class CfnImageProps():
    ...
    @builtins.property
    def image_tests_configuration(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnImage.ImageTestsConfigurationProperty"]]]:
        """``AWS::ImageBuilder::Image.ImageTestsConfiguration``.
