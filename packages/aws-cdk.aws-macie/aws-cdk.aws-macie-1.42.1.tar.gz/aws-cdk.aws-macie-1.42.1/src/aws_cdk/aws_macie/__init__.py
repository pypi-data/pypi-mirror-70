...
class CfnCustomDataIdentifier(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-macie.CfnCustomDataIdentifier"):
    ...
    @ignore_words.setter
    def ignore_words(self, value: typing.Optional[typing.List[str]]):
    ...
    @keywords.setter
    def keywords(self, value: typing.Optional[typing.List[str]]):
    ...
    def maximum_match_distance(self, value: typing.Optional[jsii.Number]):
...
class CfnFindingsFilter(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-macie.CfnFindingsFilter"):
    ...
    def finding_criteria(self, value: typing.Union["FindingCriteriaProperty", aws_cdk.core.IResolvable]):
    ...
    @action.setter
    def action(self, value: typing.Optional[str]):
    ...
    @position.setter
    def position(self, value: typing.Optional[jsii.Number]):
    ...
    class FindingCriteriaProperty():
        def __init__(self, *, criterion: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnFindingsFilter.CriterionProperty"]]]=None) -> None:
            """
        ...
        @builtins.property
        def criterion(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnFindingsFilter.CriterionProperty"]]]:
