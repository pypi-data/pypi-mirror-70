...
class MetadataEntry(aws_cdk.cloud_assembly_schema.MetadataEntry):
    def __init__(self, *, type: str, data: typing.Optional[typing.Union[str, aws_cdk.cloud_assembly_schema.FileAssetMetadataEntry, aws_cdk.cloud_assembly_schema.ContainerImageAssetMetadataEntry, typing.List[aws_cdk.cloud_assembly_schema.Tag]]]=None, trace: typing.Optional[typing.List[str]]=None) -> None:
    ...
    @builtins.property
    def data(self) -> typing.Optional[typing.Union[str, aws_cdk.cloud_assembly_schema.FileAssetMetadataEntry, aws_cdk.cloud_assembly_schema.ContainerImageAssetMetadataEntry, typing.List[aws_cdk.cloud_assembly_schema.Tag]]]:
        """The data.
...
class MetadataEntryResult(aws_cdk.cloud_assembly_schema.MetadataEntry):
    def __init__(self, *, type: str, data: typing.Optional[typing.Union[str, aws_cdk.cloud_assembly_schema.FileAssetMetadataEntry, aws_cdk.cloud_assembly_schema.ContainerImageAssetMetadataEntry, typing.List[aws_cdk.cloud_assembly_schema.Tag]]]=None, trace: typing.Optional[typing.List[str]]=None, path: str) -> None:
        """
        :param type: The type of the metadata entry.
        :param data: The data. Default: - no data.
        :param trace: A stack trace for when the entry was created. Default: - no trace.
