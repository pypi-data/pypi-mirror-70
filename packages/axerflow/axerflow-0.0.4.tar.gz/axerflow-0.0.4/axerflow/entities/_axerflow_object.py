...
def to_string(obj):
    return _AxerflowObjectPrinter().to_string(obj)
...
class _AxerflowObjectPrinter(object):

    def __init__(self):
        super(_AxerflowObjectPrinter, self).__init__()
        self.printer = pprint.PrettyPrinter()

    def to_string(self, obj):
        if isinstance(obj, _AxerflowObject):
