...
from axerflow.entities.model_registry.model_version_status import ModelVersionStatus
from axerflow.protos.model_registry_pb2 import ModelVersion as ProtoModelVersion
...
class ModelVersion(_ModelRegistryEntity):
    ...
    Axerflow entity for Model Version.
    """
    ...
    @property
    def run_id(self):
        """String. Axerflow run ID that generated this model."""
        return self._run_id
    ...
    def from_proto(cls, proto):
        # input: axerflow.protos.model_registry_pb2.ModelVersion
    ...
    def to_proto(self):
        ...
        # returns axerflow.protos.model_registry_pb2.ModelVersion
