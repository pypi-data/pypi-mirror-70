from axerflow.entities.model_registry.model_version import ModelVersion
from axerflow.entities.model_registry._model_registry_entity import _ModelRegistryEntity
from axerflow.protos.model_registry_pb2 import RegisteredModel as ProtoRegisteredModel
...
class RegisteredModel(_ModelRegistryEntity):
    ...
    Axerflow entity for Registered Model.
    """
    ...
    def latest_versions(self):
        """List of the latest :py:class:`axerflow.entities.model_registry.ModelVersion` instances
        for each stage"""
    ...
    def from_proto(cls, proto):
        # input: axerflow.protos.model_registry_pb2.RegisteredModel
    ...
    def to_proto(self):
        # returns axerflow.protos.model_registry_pb2.RegisteredModel
