...
from axerflow.protos.databricks_pb2 import INTERNAL_ERROR, TEMPORARILY_UNAVAILABLE, \
...
class AxerflowException(Exception):
    """
    ...
    def __init__(self, message, error_code=INTERNAL_ERROR, **kwargs):
        ...
        super(AxerflowException, self).__init__(message)
...
class RestException(AxerflowException):
...
class ExecutionException(AxerflowException):
    """Exception thrown when executing a project fails"""
    pass


class MissingConfigException(AxerflowException):
