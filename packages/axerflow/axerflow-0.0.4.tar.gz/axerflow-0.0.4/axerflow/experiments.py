...
from axerflow.data import is_uri
from axerflow.entities import ViewType
from axerflow.tracking import _get_store, fluent
...
@click.option("--artifact-location", "-l",
              help="Base location for runs to store artifact results. Artifacts will be stored "
                   ...
                   "https://axerflow.org/docs/latest/tracking.html#where-runs-are-recorded for "
