"""
The ``axerflow.h2o`` module provides an API for logging and loading H2O models. This module exports
...
def save_model(h2o_model, path, conda_env=None, axerflow_model=None, settings=None,
    ...
    pyfunc.add_to_model(axerflow_model, loader_module="axerflow.h2o",
                        data=model_data_subpath, env=conda_env_subpath)
    axerflow_model.add_flavor(FLAVOR_NAME, h2o_version=h2o.__version__, data=model_data_subpath)
...
def log_model(h2o_model, artifact_path, conda_env=None, registered_model_name=None,
              ...
              **kwargs):
    """
    Log an H2O model as an Axerflow artifact for the current run.
    ...
    """
    Model.log(artifact_path=artifact_path, flavor=axerflow.h2o,
...
def _load_pyfunc(path):
    ...
    :param path: Local filesystem path to the Axerflow Model with the ``h2o`` flavor.
    """
...
def load_model(model_uri):
    ...
    # Flavor configurations for models saved in Axerflow version <= 0.8.0 may not contain a
