...
mapping is used to select suitable flavor when deploying generic Axerflow models.
...
"""
import axerflow.pyfunc as pyfunc
from axerflow.pyfunc.backend import PyFuncBackend
from axerflow.rfunc.backend import RFuncBackend
