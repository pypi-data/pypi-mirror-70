"""
The ``axerflow.onnx`` module provides APIs for logging and loading ONNX models in the Axerflow Model
format. This module exports Axerflow Models with the following flavors:
...
from axerflow.protos.databricks_pb2 import RESOURCE_ALREADY_EXISTS
...
@experimental
def save_model(onnx_model, path, conda_env=None, axerflow_model=None,
    ...
    pyfunc.add_to_model(axerflow_model, loader_module="axerflow.onnx",
                        data=model_data_subpath, env=conda_env_subpath)
    axerflow_model.add_flavor(FLAVOR_NAME, onnx_version=onnx.__version__, data=model_data_subpath)
...
class _OnnxModelWrapper:
    ...
    def predict(self, dataframe):
        ...
        # https://github.com/axerflow/axerflow/issues/1286. Meanwhile, we explicitly cast the input to
        ...
        def format_output(data):
            ...
            # https://github.com/axerflow/axerflow/issues/2499
...
def load_model(model_uri):
    ...
    :param model_uri: The location, in URI format, of the Axerflow model, for example:
                      ...
                      `Artifacts Documentation <https://www.axerflow.org/docs/latest/
...
def log_model(onnx_model, artifact_path, conda_env=None, registered_model_name=None,
              signature: ModelSignature=None, input_example: ModelInputExample=None):
    """
    Log an ONNX model as an Axerflow artifact for the current run.
    ...
    """
    Model.log(artifact_path=artifact_path, flavor=axerflow.onnx,
