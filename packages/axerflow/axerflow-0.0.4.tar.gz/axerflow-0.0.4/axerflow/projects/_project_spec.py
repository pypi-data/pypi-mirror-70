...
from axerflow.tracking import artifact_utils
from axerflow.utils.file_utils import get_local_path_or_none
...
class Project(object):
    ...
    def get_entry_point(self, entry_point):
        ...
        if file_extension in ext_to_cmd:
            ...
            command = "Rscript -e \"axerflow::axerflow_source('%s')\" --args" % shlex_quote(entry_point)
            return EntryPoint(name=entry_point, parameters={}, command=command)
