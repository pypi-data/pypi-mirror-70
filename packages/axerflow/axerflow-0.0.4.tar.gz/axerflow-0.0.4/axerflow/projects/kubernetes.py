...
from axerflow.projects.submitted_run import SubmittedRun
...
class KubernetesSubmittedRun(SubmittedRun):
    """
    Instance of SubmittedRun corresponding to a Kubernetes Job run launched to run an Axerflow
    project.
    :param axerflow_run_id: ID of the Axerflow project run.
    ...
    def __init__(self, axerflow_run_id, job_name, job_namespace):
        super(KubernetesSubmittedRun, self).__init__()
        self._axerflow_run_id = axerflow_run_id
