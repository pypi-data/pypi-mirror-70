...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n\x10\x64\x61tabricks.proto\x12\x08\x61xerflow\x1a google/protobuf/descriptor.proto\x1a\x15scalapb/scalapb.proto\"\xd5\x01\n\x14\x44\x61tabricksRpcOptions\x12)\n\tendpoints\x18\x01 \x03(\x0b\x32\x16.axerflow.HttpEndpoint\x12(\n\nvisibility\x18\x02 \x01(\x0e\x32\x14.axerflow.Visibility\x12(\n\x0b\x65rror_codes\x18\x03 \x03(\x0e\x32\x13.axerflow.ErrorCode\x12\'\n\nrate_limit\x18\x04 \x01(\x0b\x32\x13.axerflow.RateLimit\x12\x15\n\rrpc_doc_title\x18\x05 \x01(\t\"W\n\x0cHttpEndpoint\x12\x14\n\x06method\x18\x01 \x01(\t:\x04POST\x12\x0c\n\x04path\x18\x02 \x01(\t\x12#\n\x05since\x18\x03 \x01(\x0b\x32\x14.axerflow.ApiVersion\"*\n\nApiVersion\x12\r\n\x05major\x18\x01 \x01(\x05\x12\r\n\x05minor\x18\x02 \x01(\x05\"@\n\tRateLimit\x12\x11\n\tmax_burst\x18\x01 \x01(\x03\x12 \n\x18max_sustained_per_second\x18\x02 \x01(\x03\"\x95\x01\n\x15\x44ocumentationMetadata\x12\x11\n\tdocstring\x18\x01 \x01(\t\x12\x10\n\x08lead_doc\x18\x02 \x01(\t\x12(\n\nvisibility\x18\x03 \x01(\x0e\x32\x14.axerflow.Visibility\x12\x1b\n\x13original_proto_path\x18\x04 \x03(\t\x12\x10\n\x08position\x18\x05 \x01(\x05\"p\n\x1f\x44\x61tabricksServiceExceptionProto\x12\'\n\nerror_code\x18\x01 \x01(\x0e\x32\x13.axerflow.ErrorCode\x12\x0f\n\x07message\x18\x02 \x01(\t\x12\x13\n\x0bstack_trace\x18\x03 \x01(\t*?\n\nVisibility\x12\n\n\x06PUBLIC\x10\x01\x12\x0c\n\x08INTERNAL\x10\x02\x12\x17\n\x13PUBLIC_UNDOCUMENTED\x10\x03*\xf6\x04\n\tErrorCode\x12\x12\n\x0eINTERNAL_ERROR\x10\x01\x12\x1b\n\x17TEMPORARILY_UNAVAILABLE\x10\x02\x12\x0c\n\x08IO_ERROR\x10\x03\x12\x0f\n\x0b\x42\x41\x44_REQUEST\x10\x04\x12\x1c\n\x17INVALID_PARAMETER_VALUE\x10\xe8\x07\x12\x17\n\x12\x45NDPOINT_NOT_FOUND\x10\xe9\x07\x12\x16\n\x11MALFORMED_REQUEST\x10\xea\x07\x12\x12\n\rINVALID_STATE\x10\xeb\x07\x12\x16\n\x11PERMISSION_DENIED\x10\xec\x07\x12\x15\n\x10\x46\x45\x41TURE_DISABLED\x10\xed\x07\x12\x1a\n\x15\x43USTOMER_UNAUTHORIZED\x10\xee\x07\x12\x1b\n\x16REQUEST_LIMIT_EXCEEDED\x10\xef\x07\x12\x1d\n\x18INVALID_STATE_TRANSITION\x10\xd1\x0f\x12\x1b\n\x16\x43OULD_NOT_ACQUIRE_LOCK\x10\xd2\x0f\x12\x1c\n\x17RESOURCE_ALREADY_EXISTS\x10\xb9\x17\x12\x1c\n\x17RESOURCE_DOES_NOT_EXIST\x10\xba\x17\x12\x13\n\x0eQUOTA_EXCEEDED\x10\xa1\x1f\x12\x1c\n\x17MAX_BLOCK_SIZE_EXCEEDED\x10\xa2\x1f\x12\x1b\n\x16MAX_READ_SIZE_EXCEEDED\x10\xa3\x1f\x12\x13\n\x0e\x44RY_RUN_FAILED\x10\x89\'\x12\x1c\n\x17RESOURCE_LIMIT_EXCEEDED\x10\x8a\'\x12\x18\n\x13\x44IRECTORY_NOT_EMPTY\x10\xf1.\x12\x18\n\x13\x44IRECTORY_PROTECTED\x10\xf2.\x12\x1f\n\x1aMAX_NOTEBOOK_SIZE_EXCEEDED\x10\xf3.:I\n\nvisibility\x12\x1d.google.protobuf.FieldOptions\x18\xee\x90\x03 \x01(\x0e\x32\x14.axerflow.Visibility::\n\x11validate_required\x12\x1d.google.protobuf.FieldOptions\x18\xef\x90\x03 \x01(\x08:4\n\x0bjson_inline\x12\x1d.google.protobuf.FieldOptions\x18\xf0\x90\x03 \x01(\x08:1\n\x08json_map\x12\x1d.google.protobuf.FieldOptions\x18\xf1\x90\x03 \x01(\x08:S\n\tfield_doc\x12\x1d.google.protobuf.FieldOptions\x18\xf2\x90\x03 \x03(\x0b\x32\x1f.axerflow.DocumentationMetadata:M\n\x03rpc\x12\x1e.google.protobuf.MethodOptions\x18\xee\x90\x03 \x01(\x0b\x32\x1e.axerflow.DatabricksRpcOptions:U\n\nmethod_doc\x12\x1e.google.protobuf.MethodOptions\x18\xf2\x90\x03 \x03(\x0b\x32\x1f.axerflow.DocumentationMetadata:W\n\x0bmessage_doc\x12\x1f.google.protobuf.MessageOptions\x18\xf2\x90\x03 \x03(\x0b\x32\x1f.axerflow.DocumentationMetadata:W\n\x0bservice_doc\x12\x1f.google.protobuf.ServiceOptions\x18\xf2\x90\x03 \x03(\x0b\x32\x1f.axerflow.DocumentationMetadata:Q\n\x08\x65num_doc\x12\x1c.google.protobuf.EnumOptions\x18\xf2\x90\x03 \x03(\x0b\x32\x1f.axerflow.DocumentationMetadata:X\n\x15\x65num_value_visibility\x12!.google.protobuf.EnumValueOptions\x18\xee\x90\x03 \x01(\x0e\x32\x14.axerflow.Visibility:\\\n\x0e\x65num_value_doc\x12!.google.protobuf.EnumValueOptions\x18\xf2\x90\x03 \x03(\x0b\x32\x1f.axerflow.DocumentationMetadataB*\n#com.databricks.api.proto.databricks\xe2?\x02\x10\x01')
  ,
...
visibility = _descriptor.FieldDescriptor(
  name='visibility', full_name='axerflow.visibility', index=0,
...
validate_required = _descriptor.FieldDescriptor(
  name='validate_required', full_name='axerflow.validate_required', index=1,
...
json_inline = _descriptor.FieldDescriptor(
  name='json_inline', full_name='axerflow.json_inline', index=2,
...
json_map = _descriptor.FieldDescriptor(
  name='json_map', full_name='axerflow.json_map', index=3,
...
field_doc = _descriptor.FieldDescriptor(
  name='field_doc', full_name='axerflow.field_doc', index=4,
...
rpc = _descriptor.FieldDescriptor(
  name='rpc', full_name='axerflow.rpc', index=5,
...
method_doc = _descriptor.FieldDescriptor(
  name='method_doc', full_name='axerflow.method_doc', index=6,
  number=51314, type=11, cpp_type=10, label=3,
  has_default_value=False, default_value=[],
  message_type=None, enum_type=None, containing_type=None,
  is_extension=True, extension_scope=None,
...
message_doc = _descriptor.FieldDescriptor(
  name='message_doc', full_name='axerflow.message_doc', index=7,
  number=51314, type=11, cpp_type=10, label=3,
  has_default_value=False, default_value=[],
  message_type=None, enum_type=None, containing_type=None,
  is_extension=True, extension_scope=None,
...
service_doc = _descriptor.FieldDescriptor(
  name='service_doc', full_name='axerflow.service_doc', index=8,
  number=51314, type=11, cpp_type=10, label=3,
  has_default_value=False, default_value=[],
  message_type=None, enum_type=None, containing_type=None,
  is_extension=True, extension_scope=None,
...
enum_doc = _descriptor.FieldDescriptor(
  name='enum_doc', full_name='axerflow.enum_doc', index=9,
  number=51314, type=11, cpp_type=10, label=3,
  has_default_value=False, default_value=[],
  message_type=None, enum_type=None, containing_type=None,
  is_extension=True, extension_scope=None,
...
enum_value_visibility = _descriptor.FieldDescriptor(
  name='enum_value_visibility', full_name='axerflow.enum_value_visibility', index=10,
  number=51310, type=14, cpp_type=8, label=1,
  has_default_value=False, default_value=1,
  message_type=None, enum_type=None, containing_type=None,
  is_extension=True, extension_scope=None,
...
enum_value_doc = _descriptor.FieldDescriptor(
  name='enum_value_doc', full_name='axerflow.enum_value_doc', index=11,
  number=51314, type=11, cpp_type=10, label=3,
  has_default_value=False, default_value=[],
  message_type=None, enum_type=None, containing_type=None,
  is_extension=True, extension_scope=None,
...
_DATABRICKSRPCOPTIONS = _descriptor.Descriptor(
  ...
  full_name='axerflow.DatabricksRpcOptions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='endpoints', full_name='axerflow.DatabricksRpcOptions.endpoints', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='visibility', full_name='axerflow.DatabricksRpcOptions.visibility', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='error_codes', full_name='axerflow.DatabricksRpcOptions.error_codes', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='rate_limit', full_name='axerflow.DatabricksRpcOptions.rate_limit', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='rpc_doc_title', full_name='axerflow.DatabricksRpcOptions.rpc_doc_title', index=4,
...
_HTTPENDPOINT = _descriptor.Descriptor(
  name='HttpEndpoint',
  full_name='axerflow.HttpEndpoint',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='method', full_name='axerflow.HttpEndpoint.method', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='path', full_name='axerflow.HttpEndpoint.path', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='since', full_name='axerflow.HttpEndpoint.since', index=2,
...
_APIVERSION = _descriptor.Descriptor(
  name='ApiVersion',
  full_name='axerflow.ApiVersion',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='major', full_name='axerflow.ApiVersion.major', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='minor', full_name='axerflow.ApiVersion.minor', index=1,
...
_RATELIMIT = _descriptor.Descriptor(
  name='RateLimit',
  full_name='axerflow.RateLimit',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='max_burst', full_name='axerflow.RateLimit.max_burst', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='max_sustained_per_second', full_name='axerflow.RateLimit.max_sustained_per_second', index=1,
...
_DOCUMENTATIONMETADATA = _descriptor.Descriptor(
  ...
  full_name='axerflow.DocumentationMetadata',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='docstring', full_name='axerflow.DocumentationMetadata.docstring', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='lead_doc', full_name='axerflow.DocumentationMetadata.lead_doc', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='visibility', full_name='axerflow.DocumentationMetadata.visibility', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='original_proto_path', full_name='axerflow.DocumentationMetadata.original_proto_path', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='position', full_name='axerflow.DocumentationMetadata.position', index=4,
...
_DATABRICKSSERVICEEXCEPTIONPROTO = _descriptor.Descriptor(
  ...
  full_name='axerflow.DatabricksServiceExceptionProto',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='error_code', full_name='axerflow.DatabricksServiceExceptionProto.error_code', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='message', full_name='axerflow.DatabricksServiceExceptionProto.message', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='stack_trace', full_name='axerflow.DatabricksServiceExceptionProto.stack_trace', index=2,
...
DatabricksRpcOptions = _reflection.GeneratedProtocolMessageType('DatabricksRpcOptions', (_message.Message,), dict(
  ...
  # @@protoc_insertion_point(class_scope:axerflow.DatabricksRpcOptions)
  ))
...
HttpEndpoint = _reflection.GeneratedProtocolMessageType('HttpEndpoint', (_message.Message,), dict(
  ...
  __module__ = 'databricks_pb2'
  # @@protoc_insertion_point(class_scope:axerflow.HttpEndpoint)
  ))
...
ApiVersion = _reflection.GeneratedProtocolMessageType('ApiVersion', (_message.Message,), dict(
  ...
  __module__ = 'databricks_pb2'
  # @@protoc_insertion_point(class_scope:axerflow.ApiVersion)
  ))
...
RateLimit = _reflection.GeneratedProtocolMessageType('RateLimit', (_message.Message,), dict(
  ...
  __module__ = 'databricks_pb2'
  # @@protoc_insertion_point(class_scope:axerflow.RateLimit)
  ))
...
DocumentationMetadata = _reflection.GeneratedProtocolMessageType('DocumentationMetadata', (_message.Message,), dict(
  ...
  __module__ = 'databricks_pb2'
  # @@protoc_insertion_point(class_scope:axerflow.DocumentationMetadata)
  ))
...
DatabricksServiceExceptionProto = _reflection.GeneratedProtocolMessageType('DatabricksServiceExceptionProto', (_message.Message,), dict(
  ...
  __module__ = 'databricks_pb2'
  # @@protoc_insertion_point(class_scope:axerflow.DatabricksServiceExceptionProto)
  ))
