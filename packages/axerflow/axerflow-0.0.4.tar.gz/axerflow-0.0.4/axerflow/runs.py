...
from axerflow.utils.axerflow_tags import axerflow_RUN_NAME
from axerflow.utils.time_utils import conv_longdate_to_str
...
def commands():
    ...
    axerflow_TRACKING_URI environment variable to the URL of the desired server.
    """
    pass


@commands.command("list")
@click.option("--experiment-id", envvar=axerflow.tracking._EXPERIMENT_ID_ENV_VAR, type=click.STRING,
...
def list_run(experiment_id, view):
    ...
    for run in runs:
        ...
        run_name = tags.get(axerflow_RUN_NAME, "")
