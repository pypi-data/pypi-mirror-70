...
from axerflow.utils.validation import path_not_unique, bad_path_message
from axerflow.utils import experimental

from axerflow.exceptions import AxerflowException
from axerflow.protos.databricks_pb2 import INVALID_PARAMETER_VALUE, RESOURCE_DOES_NOT_EXIST
...
def verify_artifact_path(artifact_path):
    if artifact_path and path_not_unique(artifact_path):
        raise AxerflowException("Invalid artifact path: '%s'. %s" % (artifact_path,
