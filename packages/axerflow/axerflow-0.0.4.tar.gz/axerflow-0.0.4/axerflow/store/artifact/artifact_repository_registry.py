...
from axerflow.store.artifact.azure_blob_artifact_repo import AzureBlobArtifactRepository
from axerflow.store.artifact.dbfs_artifact_repo import dbfs_artifact_repo_factory
from axerflow.store.artifact.ftp_artifact_repo import FTPArtifactRepository
from axerflow.store.artifact.gcs_artifact_repo import GCSArtifactRepository
from axerflow.store.artifact.hdfs_artifact_repo import HdfsArtifactRepository
from axerflow.store.artifact.local_artifact_repo import LocalArtifactRepository
...
from axerflow.store.artifact.s3_artifact_repo import S3ArtifactRepository
from axerflow.store.artifact.sftp_artifact_repo import SFTPArtifactRepository

from axerflow.utils.uri import get_uri_scheme
...
class ArtifactRepositoryRegistry:
    ...
    the entrypoints `axerflow.artifact_repository` group can be automatically registered through the
    ...
    def register_entrypoints(self):
        # Register artifact repositories provided by other packages
        for entrypoint in entrypoints.get_group_all("axerflow.artifact_repository"):
            try:
    ...
    def get_artifact_repository(self, artifact_uri):
        ...
        :return: An instance of `axerflow.store.ArtifactRepository` that fulfills the artifact URI
                 requirements.
        """
