...
def commands():
    """
    Upload, list, and download artifacts from an Axerflow artifact repository.

    To manage artifacts for a run associated with a tracking server, set the axerflow_TRACKING_URI
