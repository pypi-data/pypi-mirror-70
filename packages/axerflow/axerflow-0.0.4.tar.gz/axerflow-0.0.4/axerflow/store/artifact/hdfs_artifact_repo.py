...
from axerflow.utils.file_utils import mkdir, relative_path_to_artifact_path
...
class HdfsArtifactRepository(ArtifactRepository):
    ...
    def _download_file(self, remote_file_path, local_path):
        raise AxerflowException('This is not implemented. Should never be called.')
...
def hdfs_system(scheme, host, port):
    ...
    kerb_ticket = os.getenv('axerflow_KERBEROS_TICKET_CACHE')
    kerberos_user = os.getenv('axerflow_KERBEROS_USER')
    extra_conf = _parse_extra_conf(os.getenv('axerflow_PYARROW_EXTRA_CONF'))
