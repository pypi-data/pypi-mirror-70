...
class S3ArtifactRepository(ArtifactRepository):
    ...
    def get_s3_file_upload_extra_args():
        import json
        s3_file_upload_extra_args = os.environ.get('axerflow_S3_UPLOAD_EXTRA_ARGS')
    ...
    def _get_s3_client(self):
        ...
        s3_endpoint_url = os.environ.get('axerflow_S3_ENDPOINT_URL')
        # NOTE: If you need to specify this env variable, please file an issue at
        # https://github.com/axerflow/axerflow/issues so we know your use-case!
        signature_version = os.environ.get('axerflow_EXPERIMENTAL_S3_SIGNATURE_VERSION', 's3v4')
