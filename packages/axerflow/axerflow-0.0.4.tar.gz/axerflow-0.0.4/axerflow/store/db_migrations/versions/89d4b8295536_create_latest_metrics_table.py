...
from axerflow.store.tracking.dbmodels.models import SqlMetric, SqlLatestMetric
...
def _describe_migration_if_necessary(session):
    ...
    _logger.warning(
        ...
        " {issues_link}.".format(
            readme_link=(
                "https://github.com/axerflow/axerflow/blob/master/axerflow/store/db_migrations/README.md"
                "#89d4b8295536_create_latest_metrics_table"
            ),
            issues_link="https://github.com/axerflow/axerflow/issues"))
