...
class AbstractStore:
    ...
    def get_experiment(self, experiment_id):
        ...
        :return: A single :py:class:`axerflow.entities.Experiment` object if it exists,
    ...
    def update_run_info(self, run_id, run_status, end_time):
        ...
        :return: :py:class:`axerflow.entities.RunInfo` describing the updated run.
        """
        pass
    ...
    def log_metric(self, run_id, metric):
        ...
        :param metric: :py:class:`axerflow.entities.Metric` instance to log
        """
    ...
    def log_param(self, run_id, param):
        ...
        :param run_id: String id for the run
        :param param: :py:class:`axerflow.entities.Param` instance to log
        """
    ...
    def set_experiment_tag(self, experiment_id, tag):
        ...
        :param experiment_id: String id for the experiment
        :param tag: :py:class:`axerflow.entities.ExperimentTag` instance to set
        """
        pass
    ...
    def set_tag(self, run_id, tag):
        ...
        :param run_id: String id for the run
        :param tag: :py:class:`axerflow.entities.RunTag` instance to set
        """
    ...
    def _search_runs(self, experiment_ids, filter_string, run_view_type, max_results, order_by,
        ...
        :return: A tuple of ``runs`` and ``token`` where ``runs`` is a list of
            :py:class:`axerflow.entities.Run` objects that satisfy the search expressions,
    ...
    def list_run_infos(self, experiment_id, run_view_type):
        ...
        :return: A list of :py:class:`axerflow.entities.RunInfo` objects that satisfy the
            search expressions
        """
    ...
    def log_batch(self, run_id, metrics, params, tags):
        ...
        :param run_id: String id for the run
        :param metrics: List of :py:class:`axerflow.entities.Metric` instances to log
        :param params: List of :py:class:`axerflow.entities.Param` instances to log
        :param tags: List of :py:class:`axerflow.entities.RunTag` instances to log
    ...
    def record_logged_model(self, run_id, axerflow_model):
        ...
        maintained in a axerflow.models tag in JSON format.

        Note: The actual models are logged as artifacts via artifact repository.

        :param run_id: String id for the run
        :param axerflow_model: Model object to be recorded.
