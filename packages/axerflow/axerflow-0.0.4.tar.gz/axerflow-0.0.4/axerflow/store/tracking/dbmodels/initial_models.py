# Snapshot of Axerflow DB models as of the 0.9.1 release, prior to the first database migration.
# Used to standardize initial database state.
# Copied with modifications from
# https://github.com/axerflow/axerflow/blob/v0.9.1/axerflow/store/dbmodels/models.py, which
# is the first database schema that users could be running. In particular, modifications have
# been made to substitute constants from Axerflow with hard-coded values (e.g. replacing
