...
# Copied from https://github.com/axerflow/axerflow/blob/v0.9.1/axerflow/store/dbmodels/models.py, with
# modifications to substitute constants from Axerflow with hard-coded values (e.g. replacing
