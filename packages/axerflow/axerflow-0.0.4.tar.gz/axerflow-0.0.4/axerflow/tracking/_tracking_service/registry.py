from axerflow.tracking.registry import StoreRegistry
...
class TrackingStoreRegistry(StoreRegistry):
    ...
    `axerflow.tracking_store` group can be automatically registered through the
    ...
    def __init__(self):
        super(TrackingStoreRegistry, self).__init__("axerflow.tracking_store")
    ...
    def get_store(self, store_uri=None, artifact_uri=None):
        ...
        :return: An instance of `axerflow.store.tracking.AbstractStore` that fulfills the store URI
                 requirements.
        """
