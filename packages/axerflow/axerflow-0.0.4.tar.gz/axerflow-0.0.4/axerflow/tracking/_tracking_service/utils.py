...
from axerflow.store.tracking.rest_store import RestStore, DatabricksRestStore
from axerflow.tracking._tracking_service.registry import TrackingStoreRegistry
from axerflow.utils import env, rest_utils
from axerflow.utils.file_utils import path_to_local_file_uri
from axerflow.utils.databricks_utils import get_databricks_host_creds
from axerflow.utils.uri import get_db_profile_from_uri

_TRACKING_URI_ENV_VAR = "axerflow_TRACKING_URI"

# Extra environment variables which take precedence for setting the basic/bearer
# auth on http requests.
_TRACKING_USERNAME_ENV_VAR = "axerflow_TRACKING_USERNAME"
_TRACKING_PASSWORD_ENV_VAR = "axerflow_TRACKING_PASSWORD"
_TRACKING_TOKEN_ENV_VAR = "axerflow_TRACKING_TOKEN"
_TRACKING_INSECURE_TLS_ENV_VAR = "axerflow_TRACKING_INSECURE_TLS"
...
def _get_rest_store(store_uri, **_):
    def get_default_host_creds():
        return rest_utils.AxerflowHostCreds(
            host=store_uri,
