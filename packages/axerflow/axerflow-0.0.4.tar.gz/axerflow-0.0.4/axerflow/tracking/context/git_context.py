...
from axerflow.tracking.context.default_context import _get_main_file
from axerflow.utils.axerflow_tags import axerflow_GIT_COMMIT
...
class GitRunContext(RunContextProvider):
    ...
    def tags(self):
        return {
            axerflow_GIT_COMMIT: self._source_version
        }
