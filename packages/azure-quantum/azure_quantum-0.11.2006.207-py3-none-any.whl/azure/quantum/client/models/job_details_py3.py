...
class JobDetails(Model):
    ...
    def __init__(self, *, container_uri: str, input_data_format: str, provider_id: str, target: str, id: str=None, name: str=None, input_data_uri: str=None, input_params=None, metadata=None, output_data_format: str=None, **kwargs) -> None:
