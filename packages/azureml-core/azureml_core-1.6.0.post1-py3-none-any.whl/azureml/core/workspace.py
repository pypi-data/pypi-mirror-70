    ...
    * `Azure Machine Learning
    ...
    def create(name, auth=None, subscription_id=None, resource_group=None,
        ...
        :param private_endpoint_config: The private endpoint configuration to create a private endpoint to
            Azure ML workspace.
        :type private_endpoint_config: azureml.core.private_endpoint.PrivateEndPointConfiguration.
    ...
    def add_private_endpoint(self, private_endpoint_config, private_endpoint_auto_approval=True, show_output=True):
        ...
        return _commands.add_workspace_private_endpoint(self._auth, self.subscription_id, self.resource_group,
                                                        self.name,
                                                        self.location, private_endpoint_config,
                                                        private_endpoint_auto_approval, show_output)
    ...
    def private_endpoints(self):
        ...
        """
        return _commands.get_workspace_private_endpoints(self._auth, self.subscription_id, self.resource_group,
                                                         self.name)
