...
class Model(object):
    ...
    def __init__(self, workspace, name=None, id=None, tags=None, properties=None, version=None,
                 run_id=None, model_framework=None, **kwargs):
        """Model constructor.
        ...
        if _model_dto:
            self._initialize(workspace, model_dto=_model_dto)
        elif workspace:
            model_dto = self._get(workspace, name, id, tags, properties, version, model_framework, run_id)
            if model_dto:
                self._initialize(workspace, model_dto=model_dto)
            else:
    ...
    def _initialize(self, workspace, obj_dict=None, model_dto=None):
    ...
    def list(workspace, name=None, tags=None, properties=None, run_id=None, latest=False, dataset_id=None):
        ...
        model_dto_list = models_client.query(name=name, tags=tags_query, properties=properties_query, run_id=run_id,
                                             dataset_id=dataset_id, latest_version_only=latest)

        return [Model(workspace, _model_dto=model_dto) for model_dto in model_dto_list]
