...
# We cannot directly use @experimental annotation inside azureml.data as there is cyclic dependency between
# azureml.core and azureml.data. Therefore created a wrapper annotation @experiment that pull dependency
# on azureml.core during execution.
class experiment:
    ...
    def __call__(self, function):
        def wrapped_func(*args, **kwargs):
            from azureml.core._docstring_wrapper import experimental
            result = experimental(function)
