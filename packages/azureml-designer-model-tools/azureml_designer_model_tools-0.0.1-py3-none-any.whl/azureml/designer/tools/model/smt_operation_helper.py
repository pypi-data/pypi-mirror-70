...
class SMTOperationHelper:
    ...
    def _generate_base_uri(self):
        ...
        TODO here.
        Currently SMT getModelDataInfo Api only deployed to TEST env. Later we need to change to Prod SMT host.
        In https://ws-region.studioservice.azureml.com, e.g. https://australiaeast.studioservice.azureml.com

        :return: base_uri: str. The target url.
        """
        base_uri = 'https://smt-test1.azureml-test.net/api' \
