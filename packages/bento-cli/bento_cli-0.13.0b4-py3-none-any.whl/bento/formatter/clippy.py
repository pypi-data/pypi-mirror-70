...
class Clippy(Formatter):
    ...
    def _print_violation(self, violation: Finding, max_message_len: int) -> List[str]:
    ...
    def _print_error_message(self, violation: Finding) -> str:
    ...
    def dump(self, findings: FindingsMap) -> Collection[str]:
        ...
        ordered: List[Finding] = sorted(violations, key=Formatter.path_of)
