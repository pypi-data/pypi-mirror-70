...
class PdasLm(bess_base):
    """
        ...
        >>> model.predict(x)
        """
    def __init__(self, max_iter=20, exchange_num=0, path_type="seq", is_warm_start=False, sequence=None, s_min=None, s_max=None,
...
class PdasLogistic(bess_base):
    ...
    def __init__(self, max_iter=20, exchange_num=0, path_type="seq", is_warm_start=False, coef0=0, sequence=None, s_min=None, s_max=None,
                 K_max=None, epsilon=0.0001, ic_type="ebic", is_cv=False, K=5, is_screening=False
                 ):
