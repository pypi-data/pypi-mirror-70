    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "site",
                    models.ForeignKey(
                        default=django.contrib.sites.models.SiteManager.get_current,
                        on_delete=django.db.models.deletion.CASCADE,
                        to="sites.Site",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(max_length=60, unique=True, verbose_name="Descriptive name"),
                ),
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("token", "Data associated to this token"),
                            ("user", "Data associated to the owning user"),
                            ("global", "All data"),
                        ],
                        default="token",
                        max_length=15,
                        verbose_name="Privilege scope",
                    ),
                ),
                ("guid", models.UUIDField(default=uuid.uuid1, editable=False)),
                (
                    "server_group",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="django.BigBlueButtonGroup"
                    ),
                ),
                (
                    "user",
                    models.ForeignKey(
                        ...
                        verbose_name="User owning this token",
                    ),
                ),
            ],
        ),
