...
PyPi package for bimvee

bimvee - Batch Import, Manipulation, Visualisation, and Export Events etc.

The core library is at:

event-driven-robotics/bimvee

It is included here as a submodule. This repo adds the files necessary for packaging. 
