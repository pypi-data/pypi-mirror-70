...
from bosdyn.api import time_sync_service_pb2 as bosdyn_dot_api_dot_time__sync__service__pb2
...
class TimeSyncServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.TimeSyncUpdate = channel.unary_unary(
        ...
        request_serializer=bosdyn_dot_api_dot_time__sync__service__pb2.TimeSyncUpdateRequest.SerializeToString,
        response_deserializer=bosdyn_dot_api_dot_time__sync__service__pb2.TimeSyncUpdateResponse.FromString,
        )
    self.TimeSyncStatus = channel.unary_unary(
        '/bosdyn.api.TimeSyncService/TimeSyncStatus',
        request_serializer=bosdyn_dot_api_dot_time__sync__service__pb2.TimeSyncStatusRequest.SerializeToString,
        response_deserializer=bosdyn_dot_api_dot_time__sync__service__pb2.TimeSyncStatusResponse.FromString,
        )
...
def add_TimeSyncServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'TimeSyncUpdate': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=bosdyn_dot_api_dot_time__sync__service__pb2.TimeSyncUpdateRequest.FromString,
          response_serializer=bosdyn_dot_api_dot_time__sync__service__pb2.TimeSyncUpdateResponse.SerializeToString,
      ),
      'TimeSyncStatus': grpc.unary_unary_rpc_method_handler(
          servicer.TimeSyncStatus,
          request_deserializer=bosdyn_dot_api_dot_time__sync__service__pb2.TimeSyncStatusRequest.FromString,
          response_serializer=bosdyn_dot_api_dot_time__sync__service__pb2.TimeSyncStatusResponse.SerializeToString,
      ),
  }
