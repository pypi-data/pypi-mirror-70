...
class NetworkServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.GetNetworkSettings = channel.unary_unary(
        '/bosdyn.api.spot_cam.NetworkService/GetNetworkSettings',
        request_serializer=bosdyn_dot_api_dot_spot__cam_dot_network__pb2.GetNetworkSettingsRequest.SerializeToString,
        response_deserializer=bosdyn_dot_api_dot_spot__cam_dot_network__pb2.GetNetworkSettingsResponse.FromString,
        )
    self.SetNetworkSettings = channel.unary_unary(
        '/bosdyn.api.spot_cam.NetworkService/SetNetworkSettings',
        request_serializer=bosdyn_dot_api_dot_spot__cam_dot_network__pb2.SetNetworkSettingsRequest.SerializeToString,
        response_deserializer=bosdyn_dot_api_dot_spot__cam_dot_network__pb2.SetNetworkSettingsResponse.FromString,
        )
...
def add_NetworkServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'GetNetworkSettings': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=bosdyn_dot_api_dot_spot__cam_dot_network__pb2.GetNetworkSettingsRequest.FromString,
          response_serializer=bosdyn_dot_api_dot_spot__cam_dot_network__pb2.GetNetworkSettingsResponse.SerializeToString,
      ),
      'SetNetworkSettings': grpc.unary_unary_rpc_method_handler(
          servicer.SetNetworkSettings,
          request_deserializer=bosdyn_dot_api_dot_spot__cam_dot_network__pb2.SetNetworkSettingsRequest.FromString,
          response_serializer=bosdyn_dot_api_dot_spot__cam_dot_network__pb2.SetNetworkSettingsResponse.SerializeToString,
      ),
