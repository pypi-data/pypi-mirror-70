...
_TIMESYNCSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    index=1,
    containing_service=None,
    input_type=bosdyn_dot_api_dot_time__sync__pb2._TIMESYNCSTATUSREQUEST,
    output_type=bosdyn_dot_api_dot_time__sync__pb2._TIMESYNCSTATUSRESPONSE,
    options=None,
  ),
])
