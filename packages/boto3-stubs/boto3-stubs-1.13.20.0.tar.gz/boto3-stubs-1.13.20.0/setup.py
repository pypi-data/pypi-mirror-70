...
def install_master():
    ...
    if not master_installed:
        try:
            ...
            pip_main.main(["install", "mypy-boto3==1.13.20.0"])
        except Exception as e:
            print("Installation of mypy-boto3==1.13.20.0 failed", e)
...
setup(
    ...
    description="Type annotations for boto3 1.13.20, generated by mypy-boto3-buider 1.0.9",
    classifiers=[
    ...
    install_requires=["typing_extensions; python_version < '3.8'", "mypy-boto3==1.13.20.0",],
    extras_require={
        "essential": [
            "mypy-boto3-cloudformation==1.13.20.0",
        ...
        "accessanalyzer": ["mypy-boto3-accessanalyzer==1.13.20.0"],
        ...
        "apigatewayv2": ["mypy-boto3-apigatewayv2==1.13.20.0"],
        ...
        "appmesh": ["mypy-boto3-appmesh==1.13.20.0"],
        "appstream": ["mypy-boto3-appstream==1.13.20.0"],
        "appsync": ["mypy-boto3-appsync==1.13.20.0"],
        ...
        "codeguru-reviewer": ["mypy-boto3-codeguru-reviewer==1.13.20.0"],
        ...
        "compute-optimizer": ["mypy-boto3-compute-optimizer==1.13.20.0"],
        "config": ["mypy-boto3-config==1.13.20.0"],
        "connect": ["mypy-boto3-connect==1.13.20.0"],
        "connectparticipant": ["mypy-boto3-connectparticipant==1.13.20.0"],
        ...
        "docdb": ["mypy-boto3-docdb==1.13.20.0"],
        "ds": ["mypy-boto3-ds==1.13.20.0"],
        "dynamodb": ["mypy-boto3-dynamodb==1.13.20.0"],
        "dynamodbstreams": ["mypy-boto3-dynamodbstreams==1.13.20.0"],
        ...
        "gamelift": ["mypy-boto3-gamelift==1.13.20.0"],
        ...
        "guardduty": ["mypy-boto3-guardduty==1.13.20.0"],
        "health": ["mypy-boto3-health==1.13.20.0"],
        "iam": ["mypy-boto3-iam==1.13.20.0"],
        "imagebuilder": ["mypy-boto3-imagebuilder==1.13.20.0"],
        "importexport": ["mypy-boto3-importexport==1.13.20.0"],
        "inspector": ["mypy-boto3-inspector==1.13.20.0"],
        "iot": ["mypy-boto3-iot==1.13.20.0"],
        "iot-data": ["mypy-boto3-iot-data==1.13.20.0"],
        "iot-jobs-data": ["mypy-boto3-iot-jobs-data==1.13.20.0"],
        ...
        "iotevents-data": ["mypy-boto3-iotevents-data==1.13.20.0"],
        "iotsecuretunneling": ["mypy-boto3-iotsecuretunneling==1.13.20.0"],
        "iotsitewise": ["mypy-boto3-iotsitewise==1.13.20.0"],
        "iotthingsgraph": ["mypy-boto3-iotthingsgraph==1.13.20.0"],
        "kafka": ["mypy-boto3-kafka==1.13.20.0"],
        "kendra": ["mypy-boto3-kendra==1.13.20.0"],
        "kinesis": ["mypy-boto3-kinesis==1.13.20.0"],
        "kinesis-video-archived-media": ["mypy-boto3-kinesis-video-archived-media==1.13.20.0"],
        ...
        "kinesisanalyticsv2": ["mypy-boto3-kinesisanalyticsv2==1.13.20.0"],
        ...
        "license-manager": ["mypy-boto3-license-manager==1.13.20.0"],
        "lightsail": ["mypy-boto3-lightsail==1.13.20.0"],
        "logs": ["mypy-boto3-logs==1.13.20.0"],
        ...
        "marketplacecommerceanalytics": ["mypy-boto3-marketplacecommerceanalytics==1.13.20.0"],
        "mediaconnect": ["mypy-boto3-mediaconnect==1.13.20.0"],
        "mediaconvert": ["mypy-boto3-mediaconvert==1.13.20.0"],
        "medialive": ["mypy-boto3-medialive==1.13.20.0"],
        "mediapackage": ["mypy-boto3-mediapackage==1.13.20.0"],
        "mediapackage-vod": ["mypy-boto3-mediapackage-vod==1.13.20.0"],
        "mediastore": ["mypy-boto3-mediastore==1.13.20.0"],
        "mediastore-data": ["mypy-boto3-mediastore-data==1.13.20.0"],
        "mediatailor": ["mypy-boto3-mediatailor==1.13.20.0"],
        "meteringmarketplace": ["mypy-boto3-meteringmarketplace==1.13.20.0"],
        "mgh": ["mypy-boto3-mgh==1.13.20.0"],
        ...
        "personalize-runtime": ["mypy-boto3-personalize-runtime==1.13.20.0"],
        "pi": ["mypy-boto3-pi==1.13.20.0"],
        ...
        "route53resolver": ["mypy-boto3-route53resolver==1.13.20.0"],
        ...
        "secretsmanager": ["mypy-boto3-secretsmanager==1.13.20.0"],
        "securityhub": ["mypy-boto3-securityhub==1.13.20.0"],
        ...
        "snowball": ["mypy-boto3-snowball==1.13.20.0"],
        ...
        "stepfunctions": ["mypy-boto3-stepfunctions==1.13.20.0"],
        "storagegateway": ["mypy-boto3-storagegateway==1.13.20.0"],
        ...
        "worklink": ["mypy-boto3-worklink==1.13.20.0"],
