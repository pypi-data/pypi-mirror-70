...
from .apis import (
    ...
    ConditionApi, ParameterApi, DeviceTypeApi, PhysicalDeviceApi, UserApi,
)
from .modules import (
    Calibration, CalibrationConstant, CalibrationConstantVersion,
    Condition, Parameter, DeviceType, PhysicalDevice,
)
...
class CalibrationClient(CalibrationApi,
                        ...
                        DeviceTypeApi, PhysicalDeviceApi, UserApi):
    ...
    def set_calibration_constant(self, condition, cc_h):
        ...
        resp = DeviceType.get_by_name(self, device_type_name)
    ...
    def set_calibration_constant_version(self, calibration_constant_id, ccv_h):
        ...
        resp = PhysicalDevice.get_by_name(self, physical_device_name)
    ...
    def retrieve_calibration_constant_version(self, retrieve_h):
        ...
        resp = PhysicalDevice.get_by_name(self, device_name)
        if resp['success']:
        ...
        resp = CalibrationConstantVersion.get_closest_by_time(self,
                                                              cc_ids,
                                                              device_id,
                                                              event_at,
                                                              snapshot_at)
