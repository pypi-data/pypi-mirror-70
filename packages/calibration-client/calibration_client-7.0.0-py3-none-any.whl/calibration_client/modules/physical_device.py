...
from ..common.config import PHYSICAL_DEVICE, CREATE, DELETE, UPDATE, GET
...
class PhysicalDevice:
    def __init__(self, calibration_client,
                 name, karabo_da, virtual_device_name,
                 device_type_id, detector_id,
    ...
    def get_all_by_detector_id(cal_client, det_id):
        resp = cal_client.get_all_physical_devices_by_detector_id_api(det_id)
    ...
    def get_all_by_detector_and_karabo_da(cal_client, det_id, krb_da):
        resp = cal_client.get_all_physical_devices_by_det_and_krbda_api(det_id,
                                                                        krb_da)
