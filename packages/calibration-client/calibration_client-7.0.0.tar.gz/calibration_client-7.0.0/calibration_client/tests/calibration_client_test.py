...
class CalibrationClientTest(ModuleBase, unittest.TestCase):
    ...
    def test_inject_new_calibration_constant_version(self):
        ...
        assert resp_cc['device_type_id'] == -1
        ...
        assert resp_pd['id'] == -2
        assert resp_pd['name'] == ccv_h['device_name']
    ...
    def test_retrieve_calibration_constant_version(self):
        ...
        assert resp_ccv['begin_validity_at'] == expected_return['begin_validity_at']
        assert resp_ccv['end_validity_at'] == expected_return['end_validity_at']
        assert resp_ccv['begin_at'] == expected_return['begin_at']

        assert resp_ccv['flg_deployed'] == True
        assert resp_ccv['raw_data_location'] == expected_return['raw_data_location']
        ...
        assert resp_pd['id'] == -1
        assert resp_pd['name'] == expected_return_pd['name']
        assert resp_pd['flg_available'] == True
    ...
    def test_retrieve_all_calibration_constant_versions(self):
        ...
        assert resp_ccv_0['flg_good_quality'] == self.existing_db_06['flg_good_quality']

        assert resp_ccv_0['begin_validity_at'] == self.existing_db_06['begin_validity_at']
        assert resp_ccv_0['end_validity_at'] == self.existing_db_06['end_validity_at']
        assert resp_ccv_0['begin_at'] == self.existing_db_06['begin_at']

        assert resp_ccv_0['flg_deployed'] == self.existing_db_06['flg_deployed']
        assert resp_ccv_0['raw_data_location'] == self.existing_db_06['raw_data_location']
        ...
        # Special cases...
        assert resp_ccv_0['data_set_name'] == self.existing_db_06['data_set_name']
        assert resp_ccv_0['start_idx'] == self.existing_db_06['start_idx']
        assert resp_ccv_0['end_idx'] == self.existing_db_06['end_idx']

        # Calibration Constant info
        assert resp_ccv_0['calibration_constant']['id'] == self.existing_db_06['calibration_constant_id']

        # Physical Device info
        assert resp_ccv_0['physical_device']['id'] == self.existing_db_06['physical_device_id']
        ...
        assert resp_ccv_1['flg_good_quality'] == self.existing_db_05['flg_good_quality']

        assert resp_ccv_1['begin_validity_at'] == self.existing_db_05['begin_validity_at']
        assert resp_ccv_1['end_validity_at'] == self.existing_db_05['end_validity_at']
        assert resp_ccv_1['begin_at'] == self.existing_db_05['begin_at']

        assert resp_ccv_1['flg_deployed'] == self.existing_db_05['flg_deployed']
        assert resp_ccv_1['raw_data_location'] == self.existing_db_05['raw_data_location']
        ...
        # Special cases...
        assert resp_ccv_1['data_set_name'] == self.existing_db_05['data_set_name']
        assert resp_ccv_1['start_idx'] == self.existing_db_05['start_idx']
        assert resp_ccv_1['end_idx'] == self.existing_db_05['end_idx']

        # Calibration Constant info
        assert resp_ccv_1['calibration_constant']['id'] == self.existing_db_05['calibration_constant_id']

        # Physical Device info
        assert resp_ccv_1['physical_device']['id'] == self.existing_db_05['physical_device_id']
