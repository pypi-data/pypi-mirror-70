...
class User(object):
    ...
    def __init__(self, email=None, full_name=None, organization_id=None, n_pipelines_created=0, n_pipelines_executed=0, firebase_id=None, id=None, created_at=None, role_id=None, credit_remaining=None, credit_start_time=None, credit_end_time=None):  # noqa: E501
