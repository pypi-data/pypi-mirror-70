...
class UserCreate(object):
    ...
    def __init__(self, email=None, full_name=None, organization_id=None, n_pipelines_created=0, n_pipelines_executed=0, firebase_id=None, password=None, role=None):  # noqa: E501
