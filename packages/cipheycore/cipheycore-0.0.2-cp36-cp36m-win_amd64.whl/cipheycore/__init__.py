...
class caesar_key_t(object):
    ...
    def __init__(self, *args):
        _ciphey_core_py.caesar_key_t_swiginit(self, _ciphey_core_py.new_caesar_key_t(*args))
...
# Register caesar_key_t in _ciphey_core_py:
_ciphey_core_py.caesar_key_t_swigregister(caesar_key_t)
...
class analysis(object):
    ...
    def __init__(self):
        _ciphey_core_py.analysis_swiginit(self, _ciphey_core_py.new_analysis())
    __swig_destroy__ = _ciphey_core_py.delete_analysis

# Register analysis in _ciphey_core_py:
_ciphey_core_py.analysis_swigregister(analysis)
...
class simple_analysis_res(object):
    ...
    val = property(_ciphey_core_py.simple_analysis_res_val_get, _ciphey_core_py.simple_analysis_res_val_set)
