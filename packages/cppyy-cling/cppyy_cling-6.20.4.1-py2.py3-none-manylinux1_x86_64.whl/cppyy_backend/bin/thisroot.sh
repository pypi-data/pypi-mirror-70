...
if [ -z "${ROOT_PYTHON_VERSION}" ] ; then
   py_localruntimedir=/root/cppyy-backend/cling/builddir/lib/python.
   py_version=${py_localruntimedir#/root/cppyy-backend/cling/builddir/lib/python}
...
if [ ! -d "$ROOTSYS/CMakeFiles" ]; then
   pyroot_dir=/root/cppyy-backend/cling/builddir/install/cppyy_backend/lib/python./site-packages
else
