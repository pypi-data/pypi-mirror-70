...
if [ -z "${ROOT_PYTHON_VERSION}" ] ; then
   py_localruntimedir=C:/Users/wlav/Test/cppyy-backend/cling/builddir/bin/python3.6
   py_version=${py_localruntimedir#C:/Users/wlav/Test/cppyy-backend/cling/builddir/bin/python}
...
if [ ! -d "$ROOTSYS/CMakeFiles" ]; then
   pyroot_dir=C:/Users/wlav/Test/cppyy-backend/cling/builddir/install/cppyy_backend/lib/python3.6
else
