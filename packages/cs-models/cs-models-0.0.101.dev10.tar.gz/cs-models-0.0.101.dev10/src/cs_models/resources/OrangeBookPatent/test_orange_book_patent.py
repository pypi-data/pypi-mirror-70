...
class OrangeBookPatentResourceTestCase(TestCase):
    ...
    def test_create_duplicate_patent_and_product_no_and_patent_use_code(self):
        self.assertRaises(
            Exception,
            self.inst.create,
            {
                'appl_no': self.ob_patent1['appl_no'],
                'appl_type': self.ob_patent1['appl_type'],
                'delist_flag': '',
                'drug_product_flag': '',
                'drug_substance_flag': '',
                'patent_expire_date': 'Oct 30, 2009',
                'patent_no': self.ob_patent1['patent_no'],
                'patent_use_code': self.ob_patent1['patent_use_code'],
