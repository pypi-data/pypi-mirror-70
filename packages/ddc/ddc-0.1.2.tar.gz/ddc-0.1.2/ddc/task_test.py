import os
from ddc.utils import stream_exec_cmd, __build_path, get_lang_tests_dir
...
def start_test(cwd: str, lang: str, save_test_results: bool = False):
    if lang == "auto":
        ...
        for item in get_lang_tests_dir(cwd):
            new_output.append("Test lang: " + lang + ". Dir: " + item["dir_for_run_tests"])
            exit_code, lang_output = _run_test(item["dir_for_run_tests"], item["lang"], save_test_results)
