...
class Alphabet(_object):
    ...
    def __init__(self, *args):
        this = _swigwrapper.new_Alphabet(*args)
        try:
    ...
    __del__ = lambda self: None
Alphabet_swigregister = _swigwrapper.Alphabet_swigregister
...
class Output(_object):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["confidence"] = _swigwrapper.Output_confidence_set
    __swig_getmethods__["confidence"] = _swigwrapper.Output_confidence_get
    if _newclass:
        confidence = _swig_property(_swigwrapper.Output_confidence_get, _swigwrapper.Output_confidence_set)
...
class DecoderState(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, DecoderState, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, DecoderState, name)
    __repr__ = _swig_repr

    def __init__(self):
        this = _swigwrapper.new_DecoderState()
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
...
DecoderState_swigregister = _swigwrapper.DecoderState_swigregister
DecoderState_swigregister(DecoderState)
