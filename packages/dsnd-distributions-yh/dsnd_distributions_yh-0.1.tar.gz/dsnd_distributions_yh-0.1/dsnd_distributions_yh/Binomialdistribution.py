...
class Binomial(Distribution):
    ...
    def calculate_stdev(self):
        ...
        """
        stdev = 1.0 * math.sqrt(self.n * self.p * ( 1.0 - self.p ))
        return stdev
    ...
    def pdf(self, k):
        ...
        """
        return (fact(self.n)/(fact(k)*fact(self.n-k))) * math.pow(self.p,k)*math.pow((1-self.p),(self.n-k))
    ...
    def __add__(self, other):
        ...
        #sum_mean = self.n * self.p + other.n *  other.p
        #sum_stdev = self.n * self.p * (1 - self.p) + other.n *  other.p * (1 - other.p)
        n = self.n + other.n
        binomial_sum = Binomial(self.p,n)
        return binomial_sum
