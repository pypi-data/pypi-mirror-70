...
_lr_productions = [
  ...
  ('expr -> entity','expr',1,'p_expr','__init__.py',150),
  ('expr -> root','expr',1,'p_expr','__init__.py',151),
  ('root -> feature','root',1,'p_root','__init__.py',156),
  ('root -> root COMMA feature','root',3,'p_root','__init__.py',157),
  ('entityAny -> LBRACE RBRACE','entityAny',2,'p_entity_any','__init__.py',166),
  ('entity -> LBRACE NUMBER RBRACE','entity',3,'p_entity_number','__init__.py',170),
  ('entity -> LBRACE COINDEX RBRACE','entity',3,'p_entity_coindex','__init__.py',174),
  ('entity -> LBRACE QUOTE TEXT QUOTE RBRACE','entity',5,'p_entity_name','__init__.py',178),
  ('entity -> LBRACE TILDE RBRACE','entity',3,'p_entity_tilde','__init__.py',182),
  ('entityOpen -> LBRACE TEXT','entityOpen',2,'p_entity_normal_open','__init__.py',186),
  ('entityOpen -> LBRACE function','entityOpen',2,'p_entity_function_open','__init__.py',190),
  ('entityAnchor -> entityOpen anchor','entityAnchor',2,'p_entity_anchor','__init__.py',194),
  ('entityFeature -> entityOpen COLON feature','entityFeature',3,'p_entity_feature0','__init__.py',199),
  ('entityFeature -> entityAnchor COLON feature','entityFeature',3,'p_entity_feature0','__init__.py',200),
  ('entityFeature -> entityFeature COMMA feature','entityFeature',3,'p_entity_feature','__init__.py',205),
  ('entity -> entityOpen RBRACE','entity',2,'p_entity_close','__init__.py',210),
  ('entity -> entityAnchor RBRACE','entity',2,'p_entity_close','__init__.py',211),
  ('entity -> entityFeature RBRACE','entity',2,'p_entity_close','__init__.py',212),
  ('feature -> TEXT EQUAL entity','feature',3,'p_feature','__init__.py',217),
  ('feature -> TEXT EQUAL entityAny','feature',3,'p_feature','__init__.py',218),
  ('feature -> TEXT EQUAL restriction','feature',3,'p_feature','__init__.py',219),
  ('feature -> function EQUAL entity','feature',3,'p_function_feature','__init__.py',223),
  ('feature -> function EQUAL entityAny','feature',3,'p_function_feature','__init__.py',224),
  ('feature -> function EQUAL restriction','feature',3,'p_function_feature','__init__.py',225),
  ('function -> TEXT LPAREN RPAREN','function',3,'p_function_any','__init__.py',230),
  ('function -> TEXT LPAREN restriction RPAREN','function',4,'p_function_restriction','__init__.py',234),
  ('functionOpen -> TEXT LPAREN entity','functionOpen',3,'p_function_open','__init__.py',238),
  ('functionArgument -> functionOpen COMMA entity','functionArgument',3,'p_function_argument','__init__.py',242),
  ('functionArgument -> functionArgument COMMA entity','functionArgument',3,'p_function_argument','__init__.py',243),
  ('function -> functionOpen RPAREN','function',2,'p_function_close','__init__.py',248),
  ('function -> functionArgument RPAREN','function',2,'p_function_close','__init__.py',249),
  ('restriction -> SLASH entity','restriction',2,'p_restriction','__init__.py',254),
  ('restriction -> SLASH entity anchor','restriction',3,'p_restriction_anchor','__init__.py',258),
  ('anchor -> ULINE COINDEX','anchor',2,'p_anchor','__init__.py',263),
]
