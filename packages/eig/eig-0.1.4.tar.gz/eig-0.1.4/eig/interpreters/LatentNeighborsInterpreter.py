...
class LatentNeighborsInterpreter(Interpreter):
    """
    This is the Interpreter for the neighbors path in the latent space. Baseline points are computed in the original
    feature space.
    """
    ...
    def initialize_neighbors_path(neighbors_data, encoder, decoder, encoder_data=None, decoder_data=None):
        ...
        print("neighbors_data shape: ", neighbors_data.shape)
