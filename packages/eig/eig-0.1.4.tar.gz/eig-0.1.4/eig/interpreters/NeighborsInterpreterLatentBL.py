"""
NeighborsInterpreterLatentBL.py

Class for Neighbors Interpreter in the latent space (O-N-IG: original feature space Neighbors Integrated Gradients).
This class gives attributes for features using Neighbors path in the original feature space. The baseline is computed
in the latent space of the autoencoder.

Defines:
+ class NeighborsInterpreterLatentBL
...
class NeighborsInterpreterLatentBL(Interpreter):
    """
    This is the Interpreter for the neighbors path in original feature space.
    """
    def __init__(self, baselines_data, samples_data, other_data=None, nn_model=None, autoencoder=None,
