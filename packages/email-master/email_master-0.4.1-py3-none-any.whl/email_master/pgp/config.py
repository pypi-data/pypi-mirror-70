...
class PGPOuputType(object):
    ...
    def __str__(self):
        ...
        elif not self.signed and not self.encrypted and not self.verified:  # 100
            s = _PGPType.SIGNED
...
class PGPConfig(object):
    ...
    def __init__(self, pgp_action=None, pgp_private_b64="", pgp_public_b64="", pgp_password=""):
        ...
        output = isinstance(pgp_action, PGPOuputType)
    ...
    def _format_signed_payload(self, payload, signed_payload):
    ...
    def lock(self, mime_message):
        if self.pgp_action.signed and self.pgp_action.encrypted:
            ...
            with self.priv_key.unlock(self.key_pw) as k:
                ...
                return self._format_signed_payload(mime_message, payload)
        else:
