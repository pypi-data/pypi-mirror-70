...
travel_database = {
    "houston": {
        ...
        "brief_intro": "houston is the most diverse metropolitan area in texas.",
        "movie": {
    ...
    "macau": {
        ...
        "brief_intro": "macau is a city on the western side of the pearl river estuary in southern china. ",
        "movie": {
    ...
    "new orleans": {
        ...
        "brief_intro": "it is a Louisiana city on the Mississippi River, famous for its Mardi Gras celebration",
        "movie": {
    ...
    "london": {
        ...
        "brief_intro": "london is the capital and largest city of england.",
        "movie": {
    ...
    "san francisco": {
        ...
        "brief_intro": "it is the cultural, commercial, and financial center of northern california.",
        "movie": {
    ...
    "seattle": {
        ...
        "brief_intro": "it is the largest city in both the state of washington and the pacific northwest region of north america.",
        "movie": {
    ...
    "chicago": {
        ...
        "brief_intro": "It is situated on Lake Michigan in Illinois and is one of the largest cities in the United States.",
        "movie": {
    ...
    "new york city": {
        ...
        "brief_intro": "new york city has been described as the cultural, financial, and media capital of the world.",
        "movie": {
    ...
    "honolulu": {
        ...
        "brief_intro": "it is the largest city and state capital city of hawaii.",
        "movie": {
    ...
    "orlando": {
        ...
        "brief_intro": " it is a city in Florida, home to many exciting theme parks.",
        "movie": {
    ...
    "los angeles": {
        ...
        "brief_intro": "los angeles is the cultural, financial, and commercial center of southern california.",
        "movie": {
...
class RANDOM(Macro):
    ...
    def run(self, ngrams, vars, args):
        city_info = travel_database[vars["city"]]
...
travel_ont = {
    "ontology": {
        "known_cities": [
            "macau","paris","houston","chicago","london","san francisco","new orleans","seattle",
            "orlando","los angeles","bangkok","dubai","honolulu","new york city"
        ],

        "other_cities": [
            "tokyo","jakarta","chongqing","manila","delhi","seoul","mumbai","shanghai","sao paulo","beijing",
...
kb = KnowledgeBase()
kb.load_json(travel_ont)
kb.load_json_file(PATHDIR.replace('__***__', '_common.json'))
df = DialogueFlow('start', initial_speaker=DialogueFlow.Speaker.SYSTEM, macros=macros,kb=kb)
...
df.add_system_transition('ask_if_plan', 'TRAVEL_PLAN',
                       '"So, do you like to plan each step of your day or be more spontaneous about it?"'
                       '#GSRET(ask_travel_eat)')
...
df.add_system_transition('TRAVEL_PLAN_Y', 'TRAVEL_EAT',
                       '"I wish I could say that I am a good planner, but honestly I need someone like you to travel '
                         'with me to keep us on track! I bet that you plan plenty of time to enjoy your meals on '
                         'vacation. Or do you tend to scarf them down to get moving again? "'
                       '#GSRET(present_city)')
df.add_system_transition('TRAVEL_PLAN_N', 'TRAVEL_EAT',
                       '"I would say that I am pretty spontaneous too. I like to keep moving to the next fun thing! '
                         'Do you scarf down your meals in order to get moving again, or do you like to enjoy your meals '
                         'while on vacation?"'
                       '#GSRET(present_city)')
df.add_system_transition('TRAVEL_PLAN_D', 'TRAVEL_EAT',
                       '"Makes sense. A little bit of both is probably best. '
                         'I bet that you allow for plenty of time to enjoy your meals on '
                         'vacation. Or do you tend to scarf them down to get moving again?"'
                       '#GSRET(present_city)')
df.add_system_transition('ask_travel_eat', 'TRAVEL_EAT',
                       '"So, are you the type of person who spends time enjoying your meals on '
                         'vacation. Or do you tend to scarf them down to get moving again?"'
                       '#GSRET(present_city)')
...
df.add_system_transition('present_city', 'ASK_TRAVEL',
                       '"One of the most interesting cities I have heard of is " $city=#ONT(known_cities) "." #DETAIL(brief_intro) ". Have you ever been to this city before?"'
...
df.add_system_transition('share_reason_for_travel', 'CITY_DISCUSS',
                       '"I heard that " $city " " #DETAIL(reason_for_travel)". '
...
df.add_system_transition('ask_try_food', 'FOOD_RECOMMEND',
                       '"Well, I am really excited to try the " '
                         '$food=#RANDOM(famous_food)" in " $city ". Would you try that food too?"'
...
df.add_system_transition('present_attraction', 'ATTRACTION_RECOMMEND',
                       '"One place in " $city " that really caught my attention is " '
...
df.add_system_transition('present_movie', 'MOVIE_REC',
                       '"You know, since I can\'t actually travel to " $city ", '
...
df.add_system_transition('ATTRACTION_RECOMMEND_N', 'MOVIE_REC',
                       '"I guess everyone has different tastes. You know, since I can\'t actually travel there, '
                         'I was thinking of watching the movie " $movie=#RANDOM(movie) " because it takes '
                         'place in " $city ". Have you seen it?"'
                       '#GSRET(ask_user_fave_city)')
...
df.add_system_transition('REASON_NOT_SURE', 'ATTRACTION_OPINION',
                       '"Okay. Well, one place in " $city " that really caught my attention is " '
                         '$attraction=#RANDOM(tourist_attraction) ". '
                         'Would you recommend visiting it on a trip?"'
                       '#GSRET(present_movie)')
...
# Movie that takes place in $city
...
df.add_system_transition('MOVIE_REC_N', 'ASK_FAV_CITY',
                       ...
                       '#GSRET(END)')
df.add_system_transition('MOVIE_REC_HAVE_WATCHED', 'ASK_FAV_CITY',
...
df.add_user_transition('ASK_FAV_CITY', 'NO_MATCH',
