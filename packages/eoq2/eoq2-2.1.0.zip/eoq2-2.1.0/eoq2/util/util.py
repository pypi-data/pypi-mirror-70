...
Provides various eoq-related utility functions
'''
...
def ShowProgress(progress:float):
    """ Shows progress """
    print('Total progress: %d%%'%(progress))
    return


def ShowCalculatedProgress(index:float,target:float,startPercentage:float=0,targetPercentage:float=100,incrementer:float=1):
    """ Shows calculated progress """
