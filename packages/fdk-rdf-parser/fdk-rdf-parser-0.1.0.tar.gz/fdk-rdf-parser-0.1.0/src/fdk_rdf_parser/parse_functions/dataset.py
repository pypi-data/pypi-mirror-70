...
from fdk_rdf_parser.classes import Dataset, DataService
...
def parseDataService(
    dataServicesGraph: Graph, dataServiceURI: URIRef
) -> DataService:

    dataService = DataService(
        endpointURL=valueList(dataServicesGraph, dataServiceURI, dcatURI('endpointURL')),
        endpointDescription=valueList(dataServicesGraph, dataServiceURI, dcatURI('endpointDescription')),
        ...
        servesDataset=valueList(dataServicesGraph, dataServiceURI, dcatURI('servesDataset')),
    )

    dataService.addValuesFromDcatResource(parseDcatResource(dataServicesGraph, dataServiceURI))
    return dataService
