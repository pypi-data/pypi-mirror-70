...
class DBClient(Client):  # pylint: disable=R0904
    ...
    def one_session_container_multiple_study_instance_uid_item_ids(self) -> typing.Set[uuid.UUID]:
        ...
        return self.call_db(
            ...
            self.ingest_id,
            container_type="session_container_id",
    ...
    def one_acquisition_container_multiple_series_instance_uid_item_ids(self) -> typing.Set[uuid.UUID]:
        ...
        return self.call_db(
            db_transactions.one_container_multiple_uid_item_ids,
            self.ingest_id,
            container_type="acquisition_container_id",
    ...
    def find_all_item_with_uid(self, uid_condition: typing.Any) -> typing.Iterable[T.Schema]:
