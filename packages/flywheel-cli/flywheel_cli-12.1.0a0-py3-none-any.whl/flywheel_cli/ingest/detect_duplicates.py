...
def detect_uid_conflicts_in_item(item, uids, insert_errors) -> bool:
    ...
    All UID should contain the smae StudyInstanceUID and SeriesInstanceUID
    """
