...
This ONLY works if DESCRIBING one at a time (top level) can safely get a broad node. From v3,
see 'fmqlContainsTotal' (total number of contained elements seen apart from stopping) as
well as 'fmqlMaxStopped' at the global level of a Reply
"""
