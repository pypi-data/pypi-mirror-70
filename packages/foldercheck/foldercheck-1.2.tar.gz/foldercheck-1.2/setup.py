...
version = "1.2",
license = "MIT",
description = "Don't let your folders desorganized! FolderCheck lets you review each file in the folder you're ine",
author = "Anime no Sekai",
author_email = "niichannomail@gmail.com",
url = "https://github.com/Animenosekai/python_folderchecker",
download_url = "https://github.com/Animenosekai/python_folderchecker/archive/v1.2.tar.gz",
