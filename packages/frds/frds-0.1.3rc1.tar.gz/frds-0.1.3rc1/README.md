...
[`tangibility`](/frds/measures/tangibility.py),
...
![result-tangibility](/images/result-tangibility.png)
...
|----------------------------------------------|--------------------------------------------------------------|---------------|
| [tangibility](/frds/measures/tangibility.py) | Property, Plant and Equipment (Net) scaled by Assets (Total) | wrds.funda    |