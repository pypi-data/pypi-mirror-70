...
col_default_ids = {'current':1, 'potential':2, 'time':0, 'current_err':2, 'potential_err':3}
...
def ca_process(data=None, current_column=1, potential_column=2, threshold=5, min_step_length=50, pts_to_average=300, pyramid=False, area=5, reference=None, **kwargs):
	"""
...
def cp_process(data=None, current_column=1, potential_column=2, threshold=5, min_step_length=25, pts_to_average=300, pyramid=True, area=5, reference=None, **kwargs):
	"""
