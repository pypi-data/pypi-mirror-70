...
class InstagramEndPoints:
    ...
    def get_account_medias_json_link(self, variables):
        return self.ACCOUNT_MEDIAS.format( s=urllib.parse.quote_plus(__json.dumps(variables, separators=(',', ':'))) )
    ...
    def get_comments_before_comments_id_by_code(self, variables):
        return self.COMMENTS_BEFORE_COMMENT_ID_BY_CODE.format( s=urllib.parse.quote_plus(__json.dumps(variables, separators=(',', ':'))) )
    ...
    def get_last_likes_by_code(self, variables):
        return self.LIKES_BY_SHORTCODE.format( s=urllib.parse.quote_plus(__json.dumps(variables, separators=(',', ':'))) )
    ...
    def get_followers_json_link(self, variables):
        return self.FOLLOWERS_URL.format( s=urllib.parse.quote_plus(__json.dumps(variables, separators=(',', ':'))) )
    ...
    def get_following_json_link(self, variables):
        return self.FOLLOWING_URL.format( s=urllib.parse.quote_plus(__json.dumps(variables, separators=(',', ':'))) )
