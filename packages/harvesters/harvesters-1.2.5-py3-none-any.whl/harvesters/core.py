...
class Component2DImage(ComponentBase):
    ...
    def _to_np_array(self, pf_proxy):
        ...
        if self.has_part():
            ...
            print('pf           ===> {}'.format(dict_by_ints[self._buffer.pixel_format]))
            print('unpacked     ---> {}'.format(pf_proxy.alignment.unpacked_size))
            print('depth        ---> {}'.format(pf_proxy.depth_in_byte))

            nr_bytes = h * w
            print('nr_bytes (1) ---> {}'.format(nr_bytes))
        ...
        print('nr_bytes (2) ---> {}'.format(nr_bytes))
        print('len(buffer)  ---> {}'.format(len(self._buffer.raw_buffer)))
