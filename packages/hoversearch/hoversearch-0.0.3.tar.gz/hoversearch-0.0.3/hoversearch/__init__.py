...
defaultydl_opts = {'format': 'bestaudio/best','postprocessors': [{'key': 'FFmpegExtractAudio','preferredcodec': 'mp3','preferredquality': '192',}],}
class Youtube():
    def search(self, type="url", search=None, download=None, downloadformat="mp3", destination="./", ydl_opts=None):
