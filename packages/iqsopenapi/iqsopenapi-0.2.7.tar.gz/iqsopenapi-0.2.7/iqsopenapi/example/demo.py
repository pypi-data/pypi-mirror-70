...
def on_init(ctx):
    ...
    ctx.subscribe(('cu2010.SHFE','1m'),('rr2009.DCE','1m'),('rb2010.SHFE','1m'),('sc2009.INE','1m'),('rb2010.SHFE','TICK'))
    ...
    ctx.insert_func_at_time(run_time,datetime(2020,6,3,14,25,50),ctx)
