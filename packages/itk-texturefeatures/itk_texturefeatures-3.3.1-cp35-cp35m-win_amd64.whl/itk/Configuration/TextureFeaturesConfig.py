...
snake_case_functions = ('coocurrence_texture_features_image_filter', 'image_file_writer', 'image_source', 'run_length_texture_features_image_filter', 'image_to_image_filter', 'image_file_reader', )
