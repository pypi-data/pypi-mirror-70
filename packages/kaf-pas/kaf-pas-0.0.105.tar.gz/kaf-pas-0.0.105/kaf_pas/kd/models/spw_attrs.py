...
class Spw_attrsManager(Document_attributes_viewManager):
    ...
    def update_rec_spesification(data):
        settings.LOCKS.acquire(f'''Spw_attrsManager.update_rec_spesification_{data.get('document_id')}''')
        ...
        settings.LOCKS.release(f'''Spw_attrsManager.update_rec_spesification_{data.get('document_id')}''')
