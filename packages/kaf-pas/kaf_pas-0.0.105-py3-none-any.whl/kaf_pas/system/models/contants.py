...
class Contants(BaseRefHierarcy):
    ...
    class Meta:
        ...
        constraints = [
            UniqueConstraint(fields=['code'], condition=Q(parent=None), name='Contants_unique_constraint_0'),
            UniqueConstraint(fields=['code', 'parent'], name='Contants_unique_constraint_1'),
        ]
