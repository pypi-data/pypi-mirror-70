...
class ContactsAgendas(QtWidgets.QWidget):
    def __init__(self):
        ...
        self.agenda_items_cw = kammanta.widgets.checklist_cw.ChecklistWidget(kammanta.model.agenda_files)
    ...
    def on_contacts_show_create_agenda(self, i_new_agenda_name: str):
        ...
        # Creating
        agenda_name_str = kammanta.my_glob.add_suffix(i_new_agenda_name, kammanta.my_glob.TEXT_SUFFIX_STR)
...
class ContactsCw(QtWidgets.QWidget):
    ...
    def __init__(self):
        ...
        kammanta.my_glob.FswSingleton.get().addPath(contacts_dir_path_str)
        agendas_dir_path_str = kammanta.model.agenda_files.get_path()
        kammanta.my_glob.FswSingleton.get().addPath(agendas_dir_path_str)
    ...
    def on_add_new_contact_clicked(self):
        ...
        if not contact_name_str:
            ...
            return
        if not contact_name_str.lower().endswith(kammanta.my_glob.TEXT_SUFFIX_STR):
            contact_name_str += kammanta.my_glob.TEXT_SUFFIX_STR
        kammanta.my_glob.add_contact(contact_name_str)
