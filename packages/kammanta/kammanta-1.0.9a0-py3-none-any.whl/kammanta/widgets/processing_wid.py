...
class ProcessingWidgetInDock(QtWidgets.QWidget):
    ...
    def on_open_file_triggered(self):
        kammanta.my_glob.launch_string(self.source_path_str)
    ...
    def on_next_clicked(self):
        if self.delete_source_on_exit_qcb.isChecked():
            kammanta.my_glob.remove_fd(self.source_path_str)
    ...
    def on_select_source_file_clicked(self):
        reference_path_str = kammanta.my_glob.get_ref_path()
        new_source_path_str = kammanta.widgets.ref_file_selection_dlg.RefFileDialog.open_dlg_and_get_image_path()
    ...
    def update_gui(self):
        ...
        df_type = kammanta.my_glob.get_type(self.source_path_str)

        if df_type in (kammanta.my_glob.TypeEnum.note_file, kammanta.my_glob.TypeEnum.text_file):
            try:
        ...
        elif df_type == kammanta.my_glob.TypeEnum.image_file:
...
class DelegateCw(QtWidgets.QWidget):
    def __init__(self):
        ...
        self.open_email_qpb.setStyleSheet(kammanta.my_glob.EXT_BTN_STYLE_SHEET_STR)
    ...
    def on_add_new_clicked(self):
        ...
        waiting_for_obj = kammanta.model.na_files.get_item(kammanta.my_glob.WAITING_FOR_STR)
...
class DeferCw(QtWidgets.QWidget):
    def __init__(self):
        ...
        self.open_calendar_qpb.setStyleSheet(kammanta.my_glob.EXT_BTN_STYLE_SHEET_STR)
...
class SomedayMaybeCw(QtWidgets.QWidget):
    ...
    def on_add_new_clicked(self):
        ...
        someday_maybe_obj = kammanta.model.prj_fds.get_item(kammanta.my_glob.SOMEDAY_MAYBE_STR)
...
class IncubateCw(QtWidgets.QWidget):
    ...
    def on_add_new_clicked(self):
        ...
        datetime_str = qt_dt.toString(kammanta.my_glob.QT_DATETIME_FORMAT_STR)

        dest_path_str = kammanta.my_glob.add_tickler_file(datetime_str, self.source_path_str, False)

        # Opening a text editor
        kammanta.my_glob.launch_string(dest_path_str)
...
class RefDest(QtWidgets.QWidget):
    ...
    def on_select_dest_clicked(self):
        ...
        dest_path_str = kammanta.widgets.ref_file_selection_dlg.RefFileDialog.open_dlg_and_get_image_path()
        ...
        if dest_path_str:
            ...
            try:
                ...
                kammanta.my_glob.copy_fd(self.source_path_str, dest_path_str)
            # Opening a text editor
            kammanta.my_glob.launch_string(dest_path_str)
