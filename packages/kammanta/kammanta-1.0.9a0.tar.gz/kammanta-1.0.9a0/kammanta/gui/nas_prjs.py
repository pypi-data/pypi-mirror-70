...
class NAsPrjs(QtWidgets.QWidget):
    ...
    def __init__(self):
        ...
        self.next_actions_column = kammanta.widgets.checklist_cw.ChecklistWidget(kammanta.model.na_files)
        ...
        self.projects_column = kammanta.widgets.checklist_cw.ChecklistWidget(kammanta.model.prj_fds)
    ...
    def add_fsw_dirs(self):
        ...
        kammanta.my_glob.FswSingleton.get().addPath(main_dir_str)
