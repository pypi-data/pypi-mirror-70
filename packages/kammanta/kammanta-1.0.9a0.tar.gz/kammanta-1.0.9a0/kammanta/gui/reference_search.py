...
class ReferenceSearch(QtWidgets.QWidget):
    def __init__(self):
        ...
        self.favorites_qll = QtWidgets.QLabel("Favorites")
        left_vbox_l3.addWidget(self.favorites_qll)
        #self.favorites_qll.setFixedWidth(100)

        self.favorites_qlw = QtWidgets.QListWidget()
        ...
        self.add_new_fav_path_qll = QtWidgets.QLabel("- selected path here -")
        ...
        hbox_l4 = QtWidgets.QHBoxLayout()
        left_vbox_l3.addLayout(hbox_l4)
        self.add_new_fav_name_qle = QtWidgets.QLineEdit()
    ...
    def on_open_containing_dir_clicked(self):
        ...
        kammanta.my_glob.launch_string(containing_dir_path_str)
    ...
    def on_open_fod_clicked(self):
        ...
        kammanta.my_glob.launch_string(active_id_int)
    ...
    def update_fod_details(self, i_path: str):
        ...
        type_enum = kammanta.my_glob.get_type(i_path)
        # self.file_preview_qll.setPixmap(None)
        if type_enum == kammanta.my_glob.TypeEnum.dir:
        ...
        elif type_enum in (kammanta.my_glob.TypeEnum.text_file, kammanta.my_glob.TypeEnum.note_file):
        ...
        elif type_enum == kammanta.my_glob.TypeEnum.image_file:
    ...
    def on_add_fav_clicked(self):
        ...
        kammanta.my_glob.add_string_to_config(
            kammanta.my_glob.SETTINGS_SECTION_FAVORITE_REFERENCES_STR, new_fav_name_str, new_fav_path_str
        )
    ...
    def on_favourites_item_changed(self, i_new_item: QtWidgets.QListWidgetItem, i_prev_item: QtWidgets.QListWidgetItem):
        ...
        """
        favorites_dict = kammanta.my_glob.get_dictionary_from_config(
            kammanta.my_glob.SETTINGS_SECTION_FAVORITE_REFERENCES_STR
        )
        ...
        main_path_str = kammanta.my_glob.get_path()
        ref_path_str = kammanta.my_glob.get_ref_path()
    ...
    def on_search_clicked(self):
        ...
        if self.main_dir_scope_qrb.isChecked():
            search_dir_path_strlist.append(kammanta.my_glob.get_path())
        elif self.ref_dir_scope_qrb.isChecked():
            search_dir_path_strlist.append(kammanta.my_glob.get_ref_path())
