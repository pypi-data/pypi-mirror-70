...
class FileListCw(QtWidgets.QWidget):
    ...
    def update_gui(self):
        ...
        for fd_obj in all_fds_list:
            ...
            if fd_obj.get_type() == kammanta.my_glob.TypeEnum.note_file:
            ...
            if True:  # self.mini_layout_bool
                ...
                text_file_types_te = (
                    kammanta.my_glob.EntityType.text_file, kammanta.my_glob.EntityType.note_file, kammanta.my_glob.EntityType.desktop_file,
                    kammanta.my_glob.EntityType.image_file, kammanta.my_glob.EntityType.other_file
                )
