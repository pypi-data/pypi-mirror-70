...
class RefFileDialog(QtWidgets.QFileDialog):
    ...
    def on_current_changed(self, i_new_file_path: str):
        dir_or_file_type = kammanta.my_glob.get_type(i_new_file_path)
        if dir_or_file_type in (kammanta.my_glob.TypeEnum.note_file, kammanta.my_glob.TypeEnum.text_file):
            try:
