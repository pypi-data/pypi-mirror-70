...
class Klient:
    ...
    def exchange_rate(self,pair,qty):
        ...
        pair=pair.split("_")
        src_symbol,dst_symbol=pair[0],pair[1]
        sr=self.sell_rate(src_symbol,qty)["data"][0]["dst_qty"][0]
        br=self.buy_rate(dst_symbol,qty)["data"][0]["src_qty"][0]
...
if __name__ == "__main__":
    ...
    k=Klient()
    print( k.exchange_rate("USDT_DAI",20000) )
    print( k.change_24hr(pair="ETH_MANA",only_official_reserve=True) )
