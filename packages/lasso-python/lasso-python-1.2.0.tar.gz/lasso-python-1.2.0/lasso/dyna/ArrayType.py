...
class ArrayType:
    ...
    element_solid_thermal_data = "element_solid_thermal_data"#: shape: (n_states, n_solids, n_solids_thermal_vars)
    element_solid_stress = "element_solid_stress" #: shape: (n_states, n_solids, xx_yy_zz_xy_yz_xz)
    element_solid_effective_plastic_strain = \
        "element_solid_effective_plastic_strain" #: shape: (n_states, n_solids)
    element_solid_history_variables = "element_solid_history_variables" #: shape: (n_states, n_solids, n_solids_history_vars)
    element_solid_strain = "element_solid_strain" #: shape: (n_states, n_solids, xx_yy_zz_xy_yz_xz)
    ...
    element_solid_node27_element_index = "element_solid_node27_element_index" #: shape: (n_node27_solids)
    ...
    element_tshell_strain = "element_tshell_strain" #: shape: (n_states, n_tshells, upper_lower, xx_yy_zz_xy_yz_xz)
    # beams
    ...
    element_beam_shear_stress = "element_beam_shear_stress" #: shape: (n_states, n_beams, n_beams_layers, rs_rt)
    element_beam_axial_stress = "element_beam_axial_stress" #: shape: (n_states, n_beams, n_beams_layers)
    element_beam_plastic_strain = "element_beam_plastic_strain" #: shape: (n_states, n_beams, n_beams_layers)
    element_beam_axial_strain = "element_beam_axial_strain" #: shape: (n_states, n_beams, n_beams_layers)
    ...
    element_shell_bending_moment = "element_shell_bending_moment" #: shape (n_states, n_shells_non_rigid, mx_my_mxy)
    element_shell_shear_force = "element_shell_shear_force" #: shape (n_states, n_shells_non_rigid, qx_qy)
    element_shell_normal_force = "element_shell_normal_force" #: shape (n_states, n_shells_non_rigid, nx_ny_nxy)
    element_shell_thickness = "element_shell_thickness" #: shape (n_states, n_shells_non_rigid)
    element_shell_unknown_variables = "element_shell_unknown_variables" #: shape (n_states, n_shells_non_rigid, 2)
    element_shell_internal_energy = "element_shell_internal_energy" #: shape (n_states, n_shells_non_rigid)
    ...
    sph_history_vars = "sph_history_vars" #: shape: (n_states, n_sph_particles, n_sph_history_vars)
    # airbag
    ...
    airbag_particle_chamber_id = "airbag_particle_chamber_id" #: shape: (n_states, n_airbag_particles)
    ...
    airbag_particle_spin_energy = "airbag_particle_spin_energy" #: shape: (n_states, n_airbag_particles)
    airbag_particle_translation_energy = "airbag_particle_translation_energy" #: shape: (n_states, n_airbag_particles)
    airbag_particle_nearest_segment_distance = \
        "airbag_particle_nearest_segment_distance" #: shape: (n_states, n_airbag_particles)
    airbag_particle_position = "airbag_particle_position" #: shape: (n_states, n_airbag_particles, x_y_z)
    airbag_particle_velocity = "airbag_particle_velocity" #: shape: (n_states, n_airbag_particles, x_y_z)
    # rigid roads
    rigid_road_node_ids = "rigid_road_node_ids" #: shape: (rigid_road_n_nodes)
    rigid_road_node_coordinates = "rigid_road_node_coordinates" #: #: shape: (rigid_road_n_nodes, x_y_z)
    rigid_road_ids = "rigid_road_ids" #: shape: (n_roads)
    rigid_road_n_segments = "rigid_road_n_segments" #: shape: (n_roads)
    rigid_road_segment_node_ids = "rigid_road_segment_node_ids" #: list!: (n_roads, 4*n_road_segments)
    ...
    rigid_body_node_indexes_list = "rigid_body_node_indexes_list" #: list!: (n_rigid_bodies, n_rigid_body_nodes (differs))
    ...
    rigid_body_rotation_matrix = "rigid_body_rotation_matrix" #: shape: (n_states, n_rigid_bodies, 9)
    rigid_body_velocity = "rigid_body_velocity" #: shape: (n_states, n_rigid_bodies, x_y_z)
    rigid_body_rot_velocity = "rigid_body_rotational_velocity" #: shape: (n_states, n_rigid_bodies, x_y_z)
    rigid_body_acceleration = "rigid_body_acceleration" #: shape: (n_states, n_rigid_bodies, x_y_z)
    rigid_body_rot_acceleration = "rigid_body_rotational_acceleration" #: shape: (n_states, n_rigid_bodies, x_y_z)
    # contact info
