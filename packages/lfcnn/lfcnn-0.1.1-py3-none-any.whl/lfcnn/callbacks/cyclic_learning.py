...
class LearningRateFinder(Callback):
    ...
    def __init__(self, lr_min, lr_max, num_batches, beta=0.95, verbose=0):
        """Learning rate finder according to Leslie Smith.
        Starting from a small learning rate, the learning rate is increased
        exponentially after each **batch** up to the maximum learning rate.
        ...
        Args:
            ...
            verbose: Wheter to log verbose info.
        """
        super(LearningRateFinder, self).__init__()
        self.beta = beta
        self.lr_min = lr_min
        self.lr_max = lr_max
        self.lr_mult = (lr_max / lr_min) ** (1.0 / num_batches)
