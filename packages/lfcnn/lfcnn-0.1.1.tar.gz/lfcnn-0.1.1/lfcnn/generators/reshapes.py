...
def lf_identity(lf_batch: any, labels: List[any]) -> Tuple[any, List[any]]:
...
def lf_subaperture_stream(lf_batch: any, labels: List[any]) -> Tuple[any, List[any]]:
...
def lf_subaperture_stack(lf_batch: any, labels: List[any]) -> Tuple[any, List[any]]:
...
def lf_subaperture_channel_stack(lf_batch: any, labels: List[any]) -> Tuple[any, List[any]]:
...
def lf_distributed(lf_batch: any, labels: List[any]) -> Tuple[any, List[any]]:
...
def lf_crosshair(lf_batch: any, labels: List[any]) -> Tuple[dict, List[any]]:
    ...
    (batchsize, u, v, s, t, lambda)
    to
    [(batchsize, u, s, t, lambda),                        # horizontal
    (batchsize, v, s, t, lambda),                         # vertical
...
def lf_crosshair_stacked(lf_batch: any, labels: List[any]) -> Tuple[dict, List[any]]:
