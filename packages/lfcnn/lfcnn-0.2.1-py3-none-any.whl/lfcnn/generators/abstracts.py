...
class BaseGenerator(keras.utils.Sequence):
    ...
    def read_curr_data_path(self, indices_read: Union[List[int], slice]) -> Tuple[any, List[any]]:
    ...
    def read_curr_data_dict(self, indices_read: Union[List[int], slice]) -> Tuple[any, List[any]]:
    ...
    def process_data(self, lf_batch: any, labels: List[any], curr_indices: List[int]) -> Tuple[any, List[any]]:
    ...
    def reshape_data(self, lf_batch: any, labels: List[any]) -> Tuple[any, List[any]]:
