...
def _response_query(par, function_call, second_call, simple=False):
    ...
    if queries_qt == 0:
        ...
        for query in global_queries:
            query = ObjHTML('<div class="alert alert-secondary m-x-9 m-y-9 break-word pre-wrap p-bottom-0"><div class="p-bottom-14"><h4 class="m-bottom-0">Query ' + str(query_count+1) + ':</h4><p class="m-x-0 m-y-0">' + query + '</p></div></div>')
