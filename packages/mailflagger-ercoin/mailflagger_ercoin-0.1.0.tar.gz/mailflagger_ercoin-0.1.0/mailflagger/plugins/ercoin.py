...
def modify_subparser(subparser):
    ...
    group.add_argument(
        '--ercoin-node',
        help='Only domain, without protocol'
    )
    group.add_argument(
        '--ercoin-port',
        type=int,
...
# We could be tempted to use def instead of async def here, but:
# https://github.com/zeromq/pyzmq/issues/1296#issuecomment-625245222
