...
class experiment:
    ...
    def publish_image_s3(self, device_id, img_filename, timestamp = 0, metadata = {}):
        """
        ...
        # Upload to s3
        self.s3_client.upload_file(img_filename, f'mdml-{self.experiment_id.lower()}', img_filename)
        # Publish it
