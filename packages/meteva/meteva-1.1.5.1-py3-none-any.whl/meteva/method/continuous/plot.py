...
def scatter_regress(ob, fo, rtype="linear",member_list = None, ncol = None,save_path=None,show = False,dpi = 300, title="散点回归图"):
    '''
    绘制观测-预报散点图和线性回归曲线
    ...
    fig.suptitle(title, fontsize=fontsize_sup, y=1)
...
def pdf_plot(ob, fo, member_list = None,save_path=None,  show = False,dpi = 300,title="频率匹配检验图"):
    '''
...
def box_plot_continue(ob, fo, member_list=None, save_path=None, show = False,dpi = 300,title="频率对比箱须图"):
    '''
    box_plot 画一两组数据的箱型图
    ---------------
    :param Ob: 实况数据  任意维numpy数组
