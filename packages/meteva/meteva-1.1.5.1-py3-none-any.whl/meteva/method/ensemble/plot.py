...
def box_plot_ensemble(ob, fo,member_list = None, save_path=None,show = False,dpi = 300,title ="频率对比箱须图"):
    '''
    box_plot 画一两组数据的箱型图
    ---------------
...
def rank_histogram(ob,fo,save_path= None,show = False,dpi = 300,title = "排序柱状图"):
    '''
    :param ob:一维numpy数组
    :param fo: 二维numpy数组
    :param save_path:
