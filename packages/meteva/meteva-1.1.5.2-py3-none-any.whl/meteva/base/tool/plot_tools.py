...
def caculate_axis_width(xticks,fontsize,legend_num = None):
    '''
    计算绘图框的宽度
    :param xticks:
    :param fontsize:
...
def bar(array,name_list_dict = None,legend = None,axis = None,ylabel = "Value",save_path = None,show = False,dpi = 300,title = ""):
    sup_fontsize = 10
    shape = array.shape
