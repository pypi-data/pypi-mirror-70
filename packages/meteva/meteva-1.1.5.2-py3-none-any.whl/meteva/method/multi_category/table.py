...
def contingency_table_multicategory(ob, fo, member_list=None, grade_list=None, save_path=None):
    '''
    ...
    for line in range(new_Fo_shape[0]):
        ...
        if grade_list is not None:
            ...
            if len(index_list) > 30:
                ...
                return
            conf_mx = confusion_matrix(fo_piece, new_ob)
...
def frequency_table(ob,fo,member_list = None,grade_list=None, save_path=None):
    '''
