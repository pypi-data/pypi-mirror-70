...
para_list1 = [
    {
        ...
        "output":r"\\10.28.27.93\NWFD_SCMOC\RAIN03\YYYYMMDD\YYMMDDHH.TTT.nc",
    ...
    },
    {
        ...
        "output": r"\\10.28.27.93\NWFD_SCMOC\TMP\2M_ABOVE_GROUND\YYYYMMDD\YYMMDDHH.TTT.nc",
        "start": datetime.datetime(2020, 5, 20, 8, 0),
        "end": datetime.datetime(2020, 6, 1, 8, 0),
        "hour_range": [8, 21, 12],
        "dh_range": [3, 241, 3],
    ...
    },
    {
        ...
        "output": r"\\10.28.27.93\NWFD_SCMOC\WIND\10M_ABOVE_GROUND\YYYYMMDD\YYMMDDHH.TTT.nc",
        "start": datetime.datetime(2020, 5, 20, 8, 0),
        "end": datetime.datetime(2020, 6, 1, 8, 0),
        "hour_range": [8, 21, 12],
        "dh_range": [3, 241, 3],
