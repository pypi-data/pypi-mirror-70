...
def http_method_call(method):
    ...
    def deco(func):
        ...
        def wrapper(self, resource_id=None, data=None, debug=False, **q_params):
            ...
            method_call = partial(func, self=self, resource_id=resource_id, data=data, **q_params)
            return LazyResponse(method_call, url, method, data)
...
class EndpointSchema:
    ...
    def _create_endpoint(self, endpoint: EndpointInfo):
        ...
        if EndpointSchema.is_dynamic_endpoint(name):
            self._dynamic_endpoint = DynamicInnerEndpoint(self, info)
...
class DynamicInnerEndpoint(InnerEndpoint):
    ...
    def __init__(self, parent, endpoints):
        super(DynamicInnerEndpoint, self).__init__(parent, '', endpoints)
