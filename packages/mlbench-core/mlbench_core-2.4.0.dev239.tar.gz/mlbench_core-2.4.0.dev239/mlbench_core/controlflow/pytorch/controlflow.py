...
def compute_train_batch_metrics(batch_idx, loss, output, target, metrics, tracker, num_batches_per_device_train
):
    log_to_api = (
...
def record_train_batch_stats(
    batch_idx, loss, output, tracker, num_batches_per_device_train
):
