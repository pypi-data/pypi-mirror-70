...
class IUserPool(_IResource_72f7ee7e, jsii.compat.Protocol):
    ...
    def add_client(self, id: str, *, auth_flows: typing.Optional["AuthFlow"]=None, generate_secret: typing.Optional[bool]=None, o_auth: typing.Optional["OAuthSettings"]=None, prevent_user_existence_errors: typing.Optional[bool]=None, supported_identity_providers: typing.Optional[typing.List["UserPoolClientIdentityProvider"]]=None, user_pool_client_name: typing.Optional[str]=None) -> "UserPoolClient":
...
class _IUserPoolProxy(jsii.proxy_for(_IResource_72f7ee7e)):
    ...
    def add_client(self, id: str, *, auth_flows: typing.Optional["AuthFlow"]=None, generate_secret: typing.Optional[bool]=None, o_auth: typing.Optional["OAuthSettings"]=None, prevent_user_existence_errors: typing.Optional[bool]=None, supported_identity_providers: typing.Optional[typing.List["UserPoolClientIdentityProvider"]]=None, user_pool_client_name: typing.Optional[str]=None) -> "UserPoolClient":
        ...
        :stability: experimental
        """
        options = UserPoolClientOptions(auth_flows=auth_flows, generate_secret=generate_secret, o_auth=o_auth, prevent_user_existence_errors=prevent_user_existence_errors, supported_identity_providers=supported_identity_providers, user_pool_client_name=user_pool_client_name)
...
class UserPool(_Resource_884d0774, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_cognito.UserPool"):
    ...
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, auto_verify: typing.Optional["AutoVerifiedAttrs"]=None, custom_attributes: typing.Optional[typing.Mapping[str, "ICustomAttribute"]]=None, email_settings: typing.Optional["EmailSettings"]=None, lambda_triggers: typing.Optional["UserPoolTriggers"]=None, mfa: typing.Optional["Mfa"]=None, mfa_second_factor: typing.Optional["MfaSecondFactor"]=None, password_policy: typing.Optional["PasswordPolicy"]=None, required_attributes: typing.Optional["RequiredAttributes"]=None, self_sign_up_enabled: typing.Optional[bool]=None, sign_in_aliases: typing.Optional["SignInAliases"]=None, sign_in_case_sensitive: typing.Optional[bool]=None, sms_role: typing.Optional[_IRole_e69bbae4]=None, sms_role_external_id: typing.Optional[str]=None, user_invitation: typing.Optional["UserInvitationConfig"]=None, user_pool_name: typing.Optional[str]=None, user_verification: typing.Optional["UserVerificationConfig"]=None) -> None:
        """
        :param scope: -
        :param id: -
...
class UserPoolClient(_Resource_884d0774, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_cognito.UserPoolClient"):
    ...
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, user_pool: "IUserPool", auth_flows: typing.Optional["AuthFlow"]=None, generate_secret: typing.Optional[bool]=None, o_auth: typing.Optional["OAuthSettings"]=None, prevent_user_existence_errors: typing.Optional[bool]=None, supported_identity_providers: typing.Optional[typing.List["UserPoolClientIdentityProvider"]]=None, user_pool_client_name: typing.Optional[str]=None) -> None:
        """
        :param scope: -
        :param id: -
        ...
        :stability: experimental
        """
        props = UserPoolClientProps(user_pool=user_pool, auth_flows=auth_flows, generate_secret=generate_secret, o_auth=o_auth, prevent_user_existence_errors=prevent_user_existence_errors, supported_identity_providers=supported_identity_providers, user_pool_client_name=user_pool_client_name)
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_cognito.UserPoolClientOptions", jsii_struct_bases=[], name_mapping={'auth_flows': 'authFlows', 'generate_secret': 'generateSecret', 'o_auth': 'oAuth', 'prevent_user_existence_errors': 'preventUserExistenceErrors', 'supported_identity_providers': 'supportedIdentityProviders', 'user_pool_client_name': 'userPoolClientName'})
class UserPoolClientOptions():
    def __init__(self, *, auth_flows: typing.Optional["AuthFlow"]=None, generate_secret: typing.Optional[bool]=None, o_auth: typing.Optional["OAuthSettings"]=None, prevent_user_existence_errors: typing.Optional[bool]=None, supported_identity_providers: typing.Optional[typing.List["UserPoolClientIdentityProvider"]]=None, user_pool_client_name: typing.Optional[str]=None) -> None:
...
class UserPoolIdentityProviderBase(_Resource_884d0774, metaclass=jsii.JSIIAbstractClass, jsii_type="monocdk-experiment.aws_cognito.UserPoolIdentityProviderBase"):
    ...
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, user_pool: "IUserPool") -> None:
        """
        :param scope: -
        :param id: -
        ...
        :stability: experimental
        """
        props = UserPoolIdentityProviderProps(user_pool=user_pool)
...
class UserPoolIdentityProviderFacebook(UserPoolIdentityProviderBase, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_cognito.UserPoolIdentityProviderFacebook"):
    ...
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, client_id: str, client_secret: str, api_version: typing.Optional[str]=None, scopes: typing.Optional[typing.List[str]]=None, user_pool: "IUserPool") -> None:
        """
        :param scope: -
        :param id: -
        ...
        :stability: experimental
        """
        props = UserPoolIdentityProviderFacebookProps(client_id=client_id, client_secret=client_secret, api_version=api_version, scopes=scopes, user_pool=user_pool)
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_cognito.UserPoolIdentityProviderProps", jsii_struct_bases=[], name_mapping={'user_pool': 'userPool'})
class UserPoolIdentityProviderProps():
    def __init__(self, *, user_pool: "IUserPool") -> None:
...
class UserPoolIdentityProviderAmazon(UserPoolIdentityProviderBase, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_cognito.UserPoolIdentityProviderAmazon"):
    ...
    :resource:: AWS::Cognito::UserPoolIdentityProvider
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, client_id: str, client_secret: str, scopes: typing.Optional[typing.List[str]]=None, user_pool: "IUserPool") -> None:
        """
        :param scope: -
        :param id: -
        ...
        :stability: experimental
        """
        props = UserPoolIdentityProviderAmazonProps(client_id=client_id, client_secret=client_secret, scopes=scopes, user_pool=user_pool)
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_cognito.UserPoolIdentityProviderAmazonProps", jsii_struct_bases=[UserPoolIdentityProviderProps], name_mapping={'user_pool': 'userPool', 'client_id': 'clientId', 'client_secret': 'clientSecret', 'scopes': 'scopes'})
class UserPoolIdentityProviderAmazonProps(UserPoolIdentityProviderProps):
    def __init__(self, *, user_pool: "IUserPool", client_id: str, client_secret: str, scopes: typing.Optional[typing.List[str]]=None) -> None:
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_cognito.UserPoolIdentityProviderFacebookProps", jsii_struct_bases=[UserPoolIdentityProviderProps], name_mapping={'user_pool': 'userPool', 'client_id': 'clientId', 'client_secret': 'clientSecret', 'api_version': 'apiVersion', 'scopes': 'scopes'})
class UserPoolIdentityProviderFacebookProps(UserPoolIdentityProviderProps):
    def __init__(self, *, user_pool: "IUserPool", client_id: str, client_secret: str, api_version: typing.Optional[str]=None, scopes: typing.Optional[typing.List[str]]=None) -> None:
