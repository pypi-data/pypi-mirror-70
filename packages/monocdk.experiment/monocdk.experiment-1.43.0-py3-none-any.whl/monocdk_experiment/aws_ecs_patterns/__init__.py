...
@jsii.data_type(jsii_type="monocdk-experiment.aws_ecs_patterns.QueueProcessingFargateServiceProps", jsii_struct_bases=[QueueProcessingServiceBaseProps], name_mapping={'image': 'image', 'cluster': 'cluster', 'command': 'command', 'desired_task_count': 'desiredTaskCount', 'enable_ecs_managed_tags': 'enableECSManagedTags', 'enable_logging': 'enableLogging', 'environment': 'environment', 'family': 'family', 'log_driver': 'logDriver', 'max_receive_count': 'maxReceiveCount', 'max_scaling_capacity': 'maxScalingCapacity', 'propagate_tags': 'propagateTags', 'queue': 'queue', 'retention_period': 'retentionPeriod', 'scaling_steps': 'scalingSteps', 'secrets': 'secrets', 'service_name': 'serviceName', 'vpc': 'vpc', 'cpu': 'cpu', 'memory_limit_mib': 'memoryLimitMiB', 'platform_version': 'platformVersion'})
