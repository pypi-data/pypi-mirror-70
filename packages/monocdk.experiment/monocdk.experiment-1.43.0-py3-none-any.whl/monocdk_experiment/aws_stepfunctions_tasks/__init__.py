...
from .. import (Size as _Size_b4ccfc18, Construct as _Construct_f50a3f53, Duration as _Duration_5170c158, CfnTag as _CfnTag_b4661f1a)
...
from ..aws_kms import (IKey as _IKey_3336c79d, Key as _Key_85e883a2)
...
@jsii.implements(_IStepFunctionsTask_42498e2f)
class EmrAddStep(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_stepfunctions_tasks.EmrAddStep"):
    ...
    :stability: experimental
    """
    def __init__(self, *, cluster_id: str, jar: str, name: str, action_on_failure: typing.Optional["ActionOnFailure"]=None, args: typing.Optional[typing.List[str]]=None, integration_pattern: typing.Optional[_ServiceIntegrationPattern_efe8c8bf]=None, main_class: typing.Optional[str]=None, properties: typing.Optional[typing.Mapping[str, str]]=None) -> None:
        """
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_stepfunctions_tasks.EmrAddStepProps", jsii_struct_bases=[], name_mapping={'cluster_id': 'clusterId', 'jar': 'jar', 'name': 'name', 'action_on_failure': 'actionOnFailure', 'args': 'args', 'integration_pattern': 'integrationPattern', 'main_class': 'mainClass', 'properties': 'properties'})
...
@jsii.implements(_IStepFunctionsTask_42498e2f)
class EmrCancelStep(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_stepfunctions_tasks.EmrCancelStep"):
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_stepfunctions_tasks.EmrCancelStepProps", jsii_struct_bases=[], name_mapping={'cluster_id': 'clusterId', 'step_id': 'stepId'})
...
@jsii.implements(_IStepFunctionsTask_42498e2f)
class EmrCreateCluster(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_stepfunctions_tasks.EmrCreateCluster"):
    ...
    :stability: experimental
    """
    def __init__(self, *, instances: "InstancesConfigProperty", name: str, additional_info: typing.Optional[str]=None, applications: typing.Optional[typing.List["ApplicationConfigProperty"]]=None, auto_scaling_role: typing.Optional[_IRole_e69bbae4]=None, bootstrap_actions: typing.Optional[typing.List["BootstrapActionConfigProperty"]]=None, cluster_role: typing.Optional[_IRole_e69bbae4]=None, configurations: typing.Optional[typing.List["ConfigurationProperty"]]=None, custom_ami_id: typing.Optional[str]=None, ebs_root_volume_size: typing.Optional[jsii.Number]=None, integration_pattern: typing.Optional[_ServiceIntegrationPattern_efe8c8bf]=None, kerberos_attributes: typing.Optional["KerberosAttributesProperty"]=None, log_uri: typing.Optional[str]=None, release_label: typing.Optional[str]=None, scale_down_behavior: typing.Optional["EmrClusterScaleDownBehavior"]=None, security_configuration: typing.Optional[str]=None, service_role: typing.Optional[_IRole_e69bbae4]=None, tags: typing.Optional[typing.List[_CfnTag_b4661f1a]]=None, visible_to_all_users: typing.Optional[bool]=None) -> None:
        """
    ...
    class CloudWatchAlarmDefinitionProperty():
        def __init__(self, *, comparison_operator: "EmrCreateCluster.CloudWatchAlarmComparisonOperator", metric_name: str, period: _Duration_5170c158, dimensions: typing.Optional[typing.List["EmrCreateCluster.MetricDimensionProperty"]]=None, evalution_periods: typing.Optional[jsii.Number]=None, namespace: typing.Optional[str]=None, statistic: typing.Optional["EmrCreateCluster.CloudWatchAlarmStatistic"]=None, threshold: typing.Optional[jsii.Number]=None, unit: typing.Optional["EmrCreateCluster.CloudWatchAlarmUnit"]=None) -> None:
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_stepfunctions_tasks.EmrCreateCluster.VolumeSpecificationProperty", jsii_struct_bases=[], name_mapping={'size_in_gb': 'sizeInGB', 'volume_type': 'volumeType', 'iops': 'iops'})
...
@jsii.implements(_IStepFunctionsTask_42498e2f)
class EmrModifyInstanceFleetByName(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_stepfunctions_tasks.EmrModifyInstanceFleetByName"):
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_stepfunctions_tasks.EmrModifyInstanceFleetByNameProps", jsii_struct_bases=[], name_mapping={'cluster_id': 'clusterId', 'instance_fleet_name': 'instanceFleetName', 'target_on_demand_capacity': 'targetOnDemandCapacity', 'target_spot_capacity': 'targetSpotCapacity'})
...
@jsii.implements(_IStepFunctionsTask_42498e2f)
class EmrModifyInstanceGroupByName(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_stepfunctions_tasks.EmrModifyInstanceGroupByName"):
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_stepfunctions_tasks.EmrModifyInstanceGroupByNameProps", jsii_struct_bases=[], name_mapping={'cluster_id': 'clusterId', 'instance_group': 'instanceGroup', 'instance_group_name': 'instanceGroupName'})
...
@jsii.implements(_IStepFunctionsTask_42498e2f)
class EmrSetClusterTerminationProtection(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_stepfunctions_tasks.EmrSetClusterTerminationProtection"):
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_stepfunctions_tasks.EmrSetClusterTerminationProtectionProps", jsii_struct_bases=[], name_mapping={'cluster_id': 'clusterId', 'termination_protected': 'terminationProtected'})
...
@jsii.implements(_IStepFunctionsTask_42498e2f)
class EmrTerminateCluster(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_stepfunctions_tasks.EmrTerminateCluster"):
    """A Step Functions Task to terminate an EMR Cluster.

    stability
    :stability: experimental
    """
    def __init__(self, *, cluster_id: str, integration_pattern: typing.Optional[_ServiceIntegrationPattern_efe8c8bf]=None) -> None:
        """
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_stepfunctions_tasks.EmrTerminateClusterProps", jsii_struct_bases=[], name_mapping={'cluster_id': 'clusterId', 'integration_pattern': 'integrationPattern'})
...
class ISageMakerTask(_IStepFunctionsTask_42498e2f, _IGrantable_0fcfc53a, jsii.compat.Protocol):
...
class _ISageMakerTaskProxy(jsii.proxy_for(_IStepFunctionsTask_42498e2f), jsii.proxy_for(_IGrantable_0fcfc53a)):
    """Task to train a machine learning model using Amazon SageMaker.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_stepfunctions_tasks.ResourceConfig", jsii_struct_bases=[], name_mapping={'instance_count': 'instanceCount', 'instance_type': 'instanceType', 'volume_size_in_gb': 'volumeSizeInGB', 'volume_encryption_key': 'volumeEncryptionKey'})
class ResourceConfig():
    def __init__(self, *, instance_count: jsii.Number, instance_type: _InstanceType_85a97b30, volume_size_in_gb: jsii.Number, volume_encryption_key: typing.Optional[_IKey_3336c79d]=None) -> None:
...
@jsii.implements(_IGrantable_0fcfc53a, _IConnectable_a587039f, _IStepFunctionsTask_42498e2f)
class SagemakerTrainTask(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_stepfunctions_tasks.SagemakerTrainTask"):
    """Class representing the SageMaker Create Training Job task.

    stability
    :stability: experimental
    """
    def __init__(self, *, algorithm_specification: "AlgorithmSpecification", input_data_config: typing.List["Channel"], output_data_config: "OutputDataConfig", training_job_name: str, hyperparameters: typing.Optional[typing.Mapping[str, typing.Any]]=None, integration_pattern: typing.Optional[_ServiceIntegrationPattern_efe8c8bf]=None, resource_config: typing.Optional["ResourceConfig"]=None, role: typing.Optional[_IRole_e69bbae4]=None, stopping_condition: typing.Optional["StoppingCondition"]=None, tags: typing.Optional[typing.Mapping[str, str]]=None, vpc_config: typing.Optional["VpcConfig"]=None) -> None:
        """
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_stepfunctions_tasks.SagemakerTransformProps", jsii_struct_bases=[], name_mapping={'model_name': 'modelName', 'transform_input': 'transformInput', 'transform_job_name': 'transformJobName', 'transform_output': 'transformOutput', 'batch_strategy': 'batchStrategy', 'environment': 'environment', 'integration_pattern': 'integrationPattern', 'max_concurrent_transforms': 'maxConcurrentTransforms', 'max_payload_in_mb': 'maxPayloadInMB', 'role': 'role', 'tags': 'tags', 'transform_resources': 'transformResources'})
class SagemakerTransformProps():
    def __init__(self, *, model_name: str, transform_input: "TransformInput", transform_job_name: str, transform_output: "TransformOutput", batch_strategy: typing.Optional["BatchStrategy"]=None, environment: typing.Optional[typing.Mapping[str, str]]=None, integration_pattern: typing.Optional[_ServiceIntegrationPattern_efe8c8bf]=None, max_concurrent_transforms: typing.Optional[jsii.Number]=None, max_payload_in_mb: typing.Optional[jsii.Number]=None, role: typing.Optional[_IRole_e69bbae4]=None, tags: typing.Optional[typing.Mapping[str, str]]=None, transform_resources: typing.Optional["TransformResources"]=None) -> None:
...
@jsii.implements(_IStepFunctionsTask_42498e2f)
class SagemakerTransformTask(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_stepfunctions_tasks.SagemakerTransformTask"):
    """Class representing the SageMaker Create Training Job task.
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_stepfunctions_tasks.TransformResources", jsii_struct_bases=[], name_mapping={'instance_count': 'instanceCount', 'instance_type': 'instanceType', 'volume_kms_key_id': 'volumeKmsKeyId'})
class TransformResources():
    def __init__(self, *, instance_count: jsii.Number, instance_type: _InstanceType_85a97b30, volume_kms_key_id: typing.Optional[_Key_85e883a2]=None) -> None:
        """ML compute instances for the transform job.
    ...
    @builtins.property
    def volume_kms_key_id(self) -> typing.Optional[_Key_85e883a2]:
