...
@jsii.data_type(jsii_type="monocdk-experiment.aws_sns.CfnTopicProps", jsii_struct_bases=[], name_mapping={'display_name': 'displayName', 'kms_master_key_id': 'kmsMasterKeyId', 'subscription': 'subscription', 'tags': 'tags', 'topic_name': 'topicName'})
class CfnTopicProps():
