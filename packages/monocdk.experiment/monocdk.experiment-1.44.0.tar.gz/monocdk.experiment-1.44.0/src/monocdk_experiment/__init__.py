...
class ConstructNode(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.ConstructNode"):
    ...
    @builtins.classmethod
    def synth(cls, root: "ConstructNode", *, outdir: typing.Optional[str]=None, skip_validation: typing.Optional[bool]=None, runtime_info: typing.Optional[_RuntimeInfo_b6d338e9]=None) -> _CloudAssembly_32c4802d:
...
@jsii.data_type(jsii_type="monocdk-experiment.AssetStagingProps", jsii_struct_bases=[FingerprintOptions], name_mapping={'exclude': 'exclude', 'follow': 'follow', 'extra_hash': 'extraHash', 'source_path': 'sourcePath'})
...
class App(Construct, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.App"):
    ...
    @jsii.member(jsii_name="synth")
    def synth(self) -> _CloudAssembly_32c4802d:
