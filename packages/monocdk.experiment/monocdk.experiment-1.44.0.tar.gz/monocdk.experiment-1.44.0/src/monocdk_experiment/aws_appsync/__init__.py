...
@jsii.data_type(jsii_type="monocdk-experiment.aws_appsync.AuthMode", jsii_struct_bases=[], name_mapping={})
class AuthMode():
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_appsync.UserPoolConfig", jsii_struct_bases=[AuthMode], name_mapping={'user_pool': 'userPool', 'app_id_client_regex': 'appIdClientRegex', 'default_action': 'defaultAction'})
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_appsync.ApiKeyConfig", jsii_struct_bases=[AuthMode], name_mapping={'api_key_desc': 'apiKeyDesc', 'expires': 'expires'})
