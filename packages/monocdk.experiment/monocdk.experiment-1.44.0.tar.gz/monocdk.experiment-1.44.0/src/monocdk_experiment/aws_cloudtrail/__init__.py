...
class Trail(_Resource_884d0774, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_cloudtrail.Trail"):
    ...
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, bucket: typing.Optional[_IBucket_25bad983]=None, cloud_watch_log_group: typing.Optional[_ILogGroup_6b54c8e1]=None, cloud_watch_logs_retention: typing.Optional[_RetentionDays_bdc7ad1f]=None, enable_file_validation: typing.Optional[bool]=None, include_global_service_events: typing.Optional[bool]=None, is_multi_region_trail: typing.Optional[bool]=None, kms_key: typing.Optional[_IKey_3336c79d]=None, management_events: typing.Optional["ReadWriteType"]=None, s3_key_prefix: typing.Optional[str]=None, send_to_cloud_watch_logs: typing.Optional[bool]=None, sns_topic: typing.Optional[_ITopic_ef0ebe0e]=None, trail_name: typing.Optional[str]=None) -> None:
        """
        :param scope: -
        :param id: -
        ...
        :stability: experimental
        """
        props = TrailProps(bucket=bucket, cloud_watch_log_group=cloud_watch_log_group, cloud_watch_logs_retention=cloud_watch_logs_retention, enable_file_validation=enable_file_validation, include_global_service_events=include_global_service_events, is_multi_region_trail=is_multi_region_trail, kms_key=kms_key, management_events=management_events, s3_key_prefix=s3_key_prefix, send_to_cloud_watch_logs=send_to_cloud_watch_logs, sns_topic=sns_topic, trail_name=trail_name)
...
class TrailProps():
    def __init__(self, *, bucket: typing.Optional[_IBucket_25bad983]=None, cloud_watch_log_group: typing.Optional[_ILogGroup_6b54c8e1]=None, cloud_watch_logs_retention: typing.Optional[_RetentionDays_bdc7ad1f]=None, enable_file_validation: typing.Optional[bool]=None, include_global_service_events: typing.Optional[bool]=None, is_multi_region_trail: typing.Optional[bool]=None, kms_key: typing.Optional[_IKey_3336c79d]=None, management_events: typing.Optional["ReadWriteType"]=None, s3_key_prefix: typing.Optional[str]=None, send_to_cloud_watch_logs: typing.Optional[bool]=None, sns_topic: typing.Optional[_ITopic_ef0ebe0e]=None, trail_name: typing.Optional[str]=None) -> None:
