...
class Code(metaclass=jsii.JSIIAbstractClass, jsii_type="monocdk-experiment.aws_lambda.Code"):
    ...
    @builtins.classmethod
    def from_asset(cls, path: str, *, readers: typing.Optional[typing.List[_IGrantable_0fcfc53a]]=None, source_hash: typing.Optional[str]=None, exclude: typing.Optional[typing.List[str]]=None, follow: typing.Optional[_FollowMode_f74e7125]=None) -> "AssetCode":
        ...
        :stability: experimental
        """
        options = _AssetOptions_ed6c2956(readers=readers, source_hash=source_hash, exclude=exclude, follow=follow)
...
class LogRetention(_Construct_f50a3f53, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_lambda.LogRetention"):
    ...
    :stability: experimental
    """
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, log_group_name: str, retention: _RetentionDays_bdc7ad1f, role: typing.Optional[_IRole_e69bbae4]=None) -> None:
        """
        :param scope: -
        :param id: -
...
@jsii.data_type(jsii_type="monocdk-experiment.aws_lambda.LogRetentionProps", jsii_struct_bases=[], name_mapping={'log_group_name': 'logGroupName', 'retention': 'retention', 'role': 'role'})
class LogRetentionProps():
    def __init__(self, *, log_group_name: str, retention: _RetentionDays_bdc7ad1f, role: typing.Optional[_IRole_e69bbae4]=None) -> None:
...
class AssetCode(Code, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_lambda.AssetCode"):
    ...
    :stability: experimental
    """
    def __init__(self, path: str, *, readers: typing.Optional[typing.List[_IGrantable_0fcfc53a]]=None, source_hash: typing.Optional[str]=None, exclude: typing.Optional[typing.List[str]]=None, follow: typing.Optional[_FollowMode_f74e7125]=None) -> None:
        """
