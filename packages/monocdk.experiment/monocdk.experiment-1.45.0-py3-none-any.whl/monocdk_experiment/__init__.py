...
class AssetOptions():
    ...
    def asset_hash(self) -> typing.Optional[str]:
        """Specify a custom hash for this asset. If ``assetHashType`` is set it must be set to ``AssetHashType.CUSTOM``.
...
@jsii.data_type(jsii_type="monocdk-experiment.BundlingOptions", jsii_struct_bases=[], name_mapping={'image': 'image', 'command': 'command', 'environment': 'environment', 'volumes': 'volumes', 'working_directory': 'workingDirectory'})
class BundlingOptions():
    def __init__(self, *, image: "BundlingDockerImage", command: typing.Optional[typing.List[str]]=None, environment: typing.Optional[typing.Mapping[str, str]]=None, volumes: typing.Optional[typing.List["DockerVolume"]]=None, working_directory: typing.Optional[str]=None) -> None:
        """Bundling options.
...
@jsii.data_type(jsii_type="monocdk-experiment.FileAssetLocation", jsii_struct_bases=[], name_mapping={'bucket_name': 'bucketName', 'http_url': 'httpUrl', 'object_key': 'objectKey', 's3_object_url': 's3ObjectUrl', 's3_url': 's3Url'})
...
class DefaultStackSynthesizer(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.DefaultStackSynthesizer"):
    ...
    def __init__(self, *, cloud_formation_execution_role: typing.Optional[str]=None, deploy_role_arn: typing.Optional[str]=None, file_asset_publishing_external_id: typing.Optional[str]=None, file_asset_publishing_role_arn: typing.Optional[str]=None, file_assets_bucket_name: typing.Optional[str]=None, image_asset_publishing_external_id: typing.Optional[str]=None, image_asset_publishing_role_arn: typing.Optional[str]=None, image_assets_repository_name: typing.Optional[str]=None, qualifier: typing.Optional[str]=None) -> None:
        ...
        :stability: experimental
        """
        props = DefaultStackSynthesizerProps(cloud_formation_execution_role=cloud_formation_execution_role, deploy_role_arn=deploy_role_arn, file_asset_publishing_external_id=file_asset_publishing_external_id, file_asset_publishing_role_arn=file_asset_publishing_role_arn, file_assets_bucket_name=file_assets_bucket_name, image_asset_publishing_external_id=image_asset_publishing_external_id, image_asset_publishing_role_arn=image_asset_publishing_role_arn, image_assets_repository_name=image_assets_repository_name, qualifier=qualifier)
