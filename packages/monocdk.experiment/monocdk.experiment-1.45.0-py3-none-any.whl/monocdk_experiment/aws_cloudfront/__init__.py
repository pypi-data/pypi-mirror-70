...
class CfnDistribution(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_cloudfront.CfnDistribution"):
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_cloudfront.CfnDistribution.OriginProperty", jsii_struct_bases=[], name_mapping={'domain_name': 'domainName', 'id': 'id', 'custom_origin_config': 'customOriginConfig', 'origin_custom_headers': 'originCustomHeaders', 'origin_path': 'originPath', 's3_origin_config': 's3OriginConfig'})
