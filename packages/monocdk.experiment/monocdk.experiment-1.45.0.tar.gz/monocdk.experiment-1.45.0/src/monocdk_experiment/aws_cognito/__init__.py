...
class UserPool(_Resource_884d0774, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_cognito.UserPool"):
    ...
    def __init__(self, scope: _Construct_f50a3f53, id: str, *, auto_verify: typing.Optional["AutoVerifiedAttrs"]=None, custom_attributes: typing.Optional[typing.Mapping[str, "ICustomAttribute"]]=None, email_settings: typing.Optional["EmailSettings"]=None, lambda_triggers: typing.Optional["UserPoolTriggers"]=None, mfa: typing.Optional["Mfa"]=None, mfa_second_factor: typing.Optional["MfaSecondFactor"]=None, password_policy: typing.Optional["PasswordPolicy"]=None, self_sign_up_enabled: typing.Optional[bool]=None, sign_in_aliases: typing.Optional["SignInAliases"]=None, sign_in_case_sensitive: typing.Optional[bool]=None, sms_role: typing.Optional[_IRole_e69bbae4]=None, sms_role_external_id: typing.Optional[str]=None, standard_attributes: typing.Optional["StandardAttributes"]=None, user_invitation: typing.Optional["UserInvitationConfig"]=None, user_pool_name: typing.Optional[str]=None, user_verification: typing.Optional["UserVerificationConfig"]=None) -> None:
        ...
        :stability: experimental
        """
        props = UserPoolProps(auto_verify=auto_verify, custom_attributes=custom_attributes, email_settings=email_settings, lambda_triggers=lambda_triggers, mfa=mfa, mfa_second_factor=mfa_second_factor, password_policy=password_policy, self_sign_up_enabled=self_sign_up_enabled, sign_in_aliases=sign_in_aliases, sign_in_case_sensitive=sign_in_case_sensitive, sms_role=sms_role, sms_role_external_id=sms_role_external_id, standard_attributes=standard_attributes, user_invitation=user_invitation, user_pool_name=user_pool_name, user_verification=user_verification)
