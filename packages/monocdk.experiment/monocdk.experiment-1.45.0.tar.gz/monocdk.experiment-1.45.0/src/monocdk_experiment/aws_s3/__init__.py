...
class CfnBucket(_CfnResource_7760e8e4, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_s3.CfnBucket"):
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucket.ReplicationDestinationProperty", jsii_struct_bases=[], name_mapping={'bucket': 'bucket', 'access_control_translation': 'accessControlTranslation', 'account': 'account', 'encryption_configuration': 'encryptionConfiguration', 'storage_class': 'storageClass'})
    class ReplicationDestinationProperty():
        def __init__(self, *, bucket: str, access_control_translation: typing.Optional[typing.Union["CfnBucket.AccessControlTranslationProperty", _IResolvable_9ceae33e]]=None, account: typing.Optional[str]=None, encryption_configuration: typing.Optional[typing.Union["CfnBucket.EncryptionConfigurationProperty", _IResolvable_9ceae33e]]=None, storage_class: typing.Optional[str]=None) -> None:
            """
    ...
    @jsii.data_type(jsii_type="monocdk-experiment.aws_s3.CfnBucket.ReplicationRuleProperty", jsii_struct_bases=[], name_mapping={'destination': 'destination', 'prefix': 'prefix', 'status': 'status', 'id': 'id', 'source_selection_criteria': 'sourceSelectionCriteria'})
    class ReplicationRuleProperty():
        def __init__(self, *, destination: typing.Union["CfnBucket.ReplicationDestinationProperty", _IResolvable_9ceae33e], prefix: str, status: str, id: typing.Optional[str]=None, source_selection_criteria: typing.Optional[typing.Union["CfnBucket.SourceSelectionCriteriaProperty", _IResolvable_9ceae33e]]=None) -> None:
            """
