...
[boto3.Athena 1.13.20](https://boto3.amazonaws.com/v1/documentation/api/1.13.20/reference/services/athena.html#Athena) service
...
list_data_catalogs_paginator: athena.ListDataCatalogsPaginator = client.get_paginator("list_data_catalogs")
list_databases_paginator: athena.ListDatabasesPaginator = client.get_paginator("list_databases")
...
list_table_metadata_paginator: athena.ListTableMetadataPaginator = client.get_paginator("list_table_metadata")
list_tags_for_resource_paginator: athena.ListTagsForResourcePaginator = client.get_paginator("list_tags_for_resource")
```
