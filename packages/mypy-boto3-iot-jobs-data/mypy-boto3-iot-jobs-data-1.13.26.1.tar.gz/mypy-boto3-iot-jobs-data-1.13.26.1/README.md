...
[boto3.IoTJobsDataPlane 1.13.26](https://boto3.amazonaws.com/v1/documentation/api/1.13.26/reference/services/iot-jobs-data.html#IoTJobsDataPlane) service
...
Use `boto3` with `mypy_boto3_iot_jobs_data` in your project and enjoy type checking and auto-complete.
...
`mypy_boto3` package can generate index for `mypy_boto3_iot_jobs_data` and other installed services.
