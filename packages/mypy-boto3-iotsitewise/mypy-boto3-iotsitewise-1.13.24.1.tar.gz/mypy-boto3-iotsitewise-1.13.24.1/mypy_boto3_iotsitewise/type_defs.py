...
Usage::
    ...
    from mypy_boto3.iotsitewise.type_defs import AccessPolicySummaryTypeDef
...
ImageFileTypeDef = TypedDict("ImageFileTypeDef", {"data": Union[bytes, IO], "type": Literal["PNG"]})
