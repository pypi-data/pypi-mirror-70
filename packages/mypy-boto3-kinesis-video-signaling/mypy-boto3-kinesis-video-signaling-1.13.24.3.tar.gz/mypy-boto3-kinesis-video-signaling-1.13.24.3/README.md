...
[boto3.KinesisVideoSignalingChannels 1.13.24](https://boto3.amazonaws.com/v1/documentation/api/1.13.24/reference/services/kinesis-video-signaling.html#KinesisVideoSignalingChannels) service
...
Use `boto3` with `mypy_boto3_kinesis_video_signaling` in your project and enjoy type checking and auto-complete.
...
`mypy_boto3` package can generate index for `mypy_boto3_kinesis_video_signaling` and other installed services.
