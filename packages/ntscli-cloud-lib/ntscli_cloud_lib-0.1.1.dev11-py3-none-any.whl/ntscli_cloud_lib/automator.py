...
class CloudStatus(betterproto.Message):
    ...
    as they are reported in these blocks, as their lifetime is not long. data
    will not be set
    """
...
@dataclass
class DeviceBatchStatusResponse(betterproto.Message):
    """
    ...
    # http status code
    status: str = betterproto.string_field(1)
    body: "CloudStatus" = betterproto.message_field(2)
