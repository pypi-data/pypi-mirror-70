...
function GetOciCommandsToLongParams_iam() {
    $ociCommandsToLongParams = @{
        ...
        'iam identity-provider list' = 'all compartment-id from-json help limit page page-size protocol'
