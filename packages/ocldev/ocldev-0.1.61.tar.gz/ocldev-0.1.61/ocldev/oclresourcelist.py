...
class OclResourceList(object):
    ...
    def get_resource_by_url(self, resource_url):
        ...
        # I think need to implement:
        #     OclResourceList.copy()
        #     OclResourceList.get() -- similar to how OclExport.get_concept works
        #     OclResourceList.get_index() -- same as get(), but returns indexes
        #     OclResourceList.pop() -- accepts an index
