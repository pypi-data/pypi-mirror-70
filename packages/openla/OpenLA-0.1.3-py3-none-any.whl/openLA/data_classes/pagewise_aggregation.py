...
class PageWiseAggregation(object):
    ...
    def operation_name(self):
        ...
        :rtype: numpy.ndarray
        """
        return self.df.columns.drop(['userid', 'contentsid', 'page no', 'reading_seconds']).values
    ...
    def operation_count(self, user_id=None, contents_id=None, operation_name=None):
        ...
        operation_count_dict = dict(df.drop(['userid', 'contentsid', 'lecture', 'pageno', 'reading_seconds', 'time_to_enter', 'time_to_leave'], axis=1).sum())
...
class PageTransition(PageWiseAggregation):
    ...
    def operation_name(self):
        ...
        :rtype: numpy.ndarray
        """
        return self.df.columns.drop(['userid', 'contentsid', 'page no', 'reading_seconds', 'time_to_enter', 'time_to_leave']).values
