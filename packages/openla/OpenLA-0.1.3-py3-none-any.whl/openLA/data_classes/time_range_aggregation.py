...
class TimeRangeAggregation(object):
    ...
    def operation_name(self):
        ...
        :rtype: numpy.ndarray
        """
        return self.df.columns.drop(['seconds', 'start_of_range', 'end_of_range', 'userid', 'contentsid', 'page no']).values
    ...
    def unique_page_num(self, user_id=None, contents_id=None):
        """
        Get the unique number of pages

        :param user_id: The user who is counted the unique number of pages read. If it is None, the total count of all users is returned.
        :type user_id: str

        :param contents_id: The contents to c. If it is None, the total count in all contents is returned.
        :type contents_id: str or None
