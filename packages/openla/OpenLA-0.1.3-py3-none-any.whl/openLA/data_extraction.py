...
def select_user(activity_record, user_id):
    """
    ...
    :param activity_record: instance of activity class
    :type activity_record: EventStream, OperationCount, or PageWise
    ...
    return_class = type(activity_record)
    return return_class(selected_user_df)


def select_contents(activity_record, contents_id):
    """
    ...
    :param activity_record: EventStream instance
    :type activity_record: EventStream
...
def select_lecture(activity_record, lecture_week):
    """
...
def select_by_lecture_time(course_info, event_stream, contents_id=None, timing='during'):
    ...
    if _is_str(contents_id):
        selected_contents_stream = select_contents(event_stream=event_stream, contents_id=contents_id)
        ...
        for i, id in enumerate(contents_id):
            ...
            selected_contents_stream = select_contents(activity_record=event_stream, contents_id=id)
