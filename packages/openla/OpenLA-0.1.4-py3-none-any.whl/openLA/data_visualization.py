...
def visualize_behavior_in_pages(pagewise_aggregation, user_id=None, contents_id=None,
                               is_plot_operation=True, is_plot_reading_time=True, operation_name=None,
                               reading_time_basis="minutes", calculate_type="total",
                               operation_bar_colors=None, reading_time_color="brown", figsize=None, save_file=None):
    """
...
def visualize_pages_in_time_range(time_range_aggregation, lecture_week, user_id=None,
