...
class HistogramFactory(openturns.model_copula.DistributionFactoryImplementation):
    ...
    def computeBandwidth(self, sample, useQuantile=True):
        ...
        and let :math:`IQ` be the inter-quartiles range:
        ...
        .. math::
            ...
            \begin{aligned}
            h = \frac{IQ}{2\Phi^{-1}(0.75)} \left(\frac{24 \sqrt{\pi}}{n}\right)^{\frac{1}{3}}
            \end{aligned}

        where :math:`\Phi^{-1}` is the quantile function of the gaussian standard 
        distribution. 
        The expression :math:`\frac{IQ}{2\Phi^{-1}(0.75)}` is the normalized inter-quartile range 
        is equal to the standard deviation of the gaussian distribution. 
