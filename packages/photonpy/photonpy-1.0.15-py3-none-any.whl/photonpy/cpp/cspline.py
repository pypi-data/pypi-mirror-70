...
class CSpline:
    ...
    def CreatePSFFromZStack(self, roisize, zstack, zrange, cuda) -> CSplinePSF:
        spline_coeff = self.ComputeSplineCoeff(zstack)
