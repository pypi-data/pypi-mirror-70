...
R = RestClient("172.29.130.138")
a = R.stop_flag.get_stop_flag()
R.stop_flag.set_stop_flag(False)
b = R.stop_flag.get_stop_flag()
d = R.stop_flag.set_stop_flag(True)
c = R.stop_flag.get_stop_flag()
pass
