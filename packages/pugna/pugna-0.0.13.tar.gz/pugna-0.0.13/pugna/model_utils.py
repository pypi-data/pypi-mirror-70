...
def save_history(history, filename):
    """saves the History of a model.fit() to a pickle file

    Args:
        history (tf History object): output from model.fit()
...
def load_history(filename):
    """load the History of a model.fit() from a pickle file
    ...
    with open(filename, 'rb') as pfile:
        history = pickle.load(filename, pfile)
