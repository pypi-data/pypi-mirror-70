...
*V2Api* | [**list**](docs/V2Api.md#list) | **GET** /v2/ | 
*V2CatalogApi* | [**list**](docs/V2CatalogApi.md#list) | **GET** /v2/_catalog | 
*V2BlobsApi* | [**partial_update**](docs/V2BlobsApi.md#partial_update) | **PATCH** /v2/{path}/blobs/uploads//{upload_pk} | Partially update an upload
*V2ListApi* | [**list**](docs/V2ListApi.md#list) | **GET** /v2/{path}/tags/list | 
*V2UploadsApi* | [**create**](docs/V2UploadsApi.md#create) | **POST** /v2/{path}/blobs/uploads/ | Create an upload
