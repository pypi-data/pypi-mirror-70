...
class ContentPackagesApi(object):
    ...
    def create(self, relative_path, filename, **kwargs):  # noqa: E501
        ...
        >>> thread = api.create(relative_path, filename, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str relative_path: Path where the artifact is located relative to distributions base_path (required)
        :param str filename: The name of the distribution package, usually of the format: {distribution}-{version}(-{build tag})?-{python tag}-{abi tag}-{platform tag}.{packagetype} (required)
        ...
        return self.create_with_http_info(relative_path, filename, **kwargs)  # noqa: E501

    def create_with_http_info(self, relative_path, filename, **kwargs):  # noqa: E501
        """Create a python package content  # noqa: E501

        Trigger an asynchronous task to create content,optionally create new repository version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_with_http_info(relative_path, filename, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('filename' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `filename` when calling `create`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('filename' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `filename` when calling `create`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def list_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['ordering', 'name', 'name__in', 'author', 'author__in', 'packagetype', 'packagetype__in', 'filename', 'filename__in', 'filename__contains', 'keywords__in', 'keywords__contains', 'repository_version', 'repository_version_added', 'repository_version_removed', 'limit', 'offset', 'fields', 'exclude_fields']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def read_with_http_info(self, python_package_content_href, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(PythonPythonPackageContentRead, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        all_params = ['python_package_content_href', 'fields', 'exclude_fields']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='PythonPythonPackageContentRead',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
