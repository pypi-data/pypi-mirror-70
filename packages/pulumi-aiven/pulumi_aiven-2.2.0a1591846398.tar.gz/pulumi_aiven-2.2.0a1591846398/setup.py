...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'aiven', '2.2.0-alpha.1591846398+ec9db500'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource aiven 2.2.0-alpha.1591846398+ec9db500`
                """)
            else:
                raise
