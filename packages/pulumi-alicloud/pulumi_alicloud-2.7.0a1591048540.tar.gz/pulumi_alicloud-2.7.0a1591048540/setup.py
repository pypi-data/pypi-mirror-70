...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', 'v2.7.0-alpha.1591048540+g56aa366e'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud v2.7.0-alpha.1591048540+g56aa366e`
                """)
            else:
                raise
