...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', 'v2.8.0-alpha.1591383166+gbdfd9e0e'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud v2.8.0-alpha.1591383166+gbdfd9e0e`
                """)
            else:
                raise
