...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', 'v2.9.0-alpha.1591718791+g65709e7a'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud v2.9.0-alpha.1591718791+g65709e7a`
                """)
            else:
                raise
