...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v3.7.0-alpha.1591040711+ge33188c4'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v3.7.0-alpha.1591040711+ge33188c4`
                """)
            else:
                raise
