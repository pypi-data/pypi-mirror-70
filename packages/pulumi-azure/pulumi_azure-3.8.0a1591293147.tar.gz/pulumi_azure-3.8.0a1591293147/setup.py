...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v3.8.0-alpha.1591293147+gf1f587dc'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v3.8.0-alpha.1591293147+gf1f587dc`
                """)
            else:
                raise
