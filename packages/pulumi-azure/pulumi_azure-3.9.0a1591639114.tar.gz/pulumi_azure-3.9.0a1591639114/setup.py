...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v3.9.0-alpha.1591639114+g64d5c30a'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v3.9.0-alpha.1591639114+g64d5c30a`
                """)
            else:
                raise
