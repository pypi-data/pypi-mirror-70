...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'consul', 'v2.3.0-alpha.1591718910+g6f87b6d'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource consul v2.3.0-alpha.1591718910+g6f87b6d`
                """)
            else:
                raise
