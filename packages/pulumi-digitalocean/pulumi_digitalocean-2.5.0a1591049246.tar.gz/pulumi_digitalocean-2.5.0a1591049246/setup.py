...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'digitalocean', 'v2.5.0-alpha.1591049246+g296c864'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource digitalocean v2.5.0-alpha.1591049246+g296c864`
                """)
            else:
                raise
