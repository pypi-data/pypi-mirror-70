...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'digitalocean', 'v2.5.0-alpha.1591268291+gdd77c14'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource digitalocean v2.5.0-alpha.1591268291+gdd77c14`
                """)
            else:
                raise
