...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'digitalocean', 'v2.6.0-alpha.1591719075+gc9f1e75'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource digitalocean v2.6.0-alpha.1591719075+gc9f1e75`
                """)
            else:
                raise
