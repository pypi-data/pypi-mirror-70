...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'digitalocean', '2.6.0-alpha.1591830871+1c741ae1'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource digitalocean 2.6.0-alpha.1591830871+1c741ae1`
                """)
            else:
                raise
