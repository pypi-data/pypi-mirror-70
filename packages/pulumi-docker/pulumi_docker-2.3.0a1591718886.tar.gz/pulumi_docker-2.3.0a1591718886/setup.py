...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'docker', 'v2.3.0-alpha.1591718886+g1611d13'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource docker v2.3.0-alpha.1591718886+g1611d13`
                """)
            else:
                raise
