...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v3.8.0-alpha.1591096661+gc5bbe2f3'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v3.8.0-alpha.1591096661+gc5bbe2f3`
                """)
            else:
                raise
