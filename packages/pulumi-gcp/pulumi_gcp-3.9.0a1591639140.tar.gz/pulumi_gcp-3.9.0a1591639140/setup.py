...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v3.9.0-alpha.1591639140+g197e7ee0'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v3.9.0-alpha.1591639140+g197e7ee0`
                """)
            else:
                raise
