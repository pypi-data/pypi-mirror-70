...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gitlab', 'v2.4.0-alpha.1591206910+gf5a0410'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gitlab v2.4.0-alpha.1591206910+gf5a0410`
                """)
            else:
                raise
