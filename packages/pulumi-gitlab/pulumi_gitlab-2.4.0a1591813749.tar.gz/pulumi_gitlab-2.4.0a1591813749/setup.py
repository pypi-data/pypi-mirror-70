...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gitlab', '2.4.0-alpha.1591813749+04f77157'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gitlab 2.4.0-alpha.1591813749+04f77157`
                """)
            else:
                raise
