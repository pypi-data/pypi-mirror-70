...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'mongodbatlas', 'v1.1.0-alpha.1591203076+g7c74625'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource mongodbatlas v1.1.0-alpha.1591203076+g7c74625`
                """)
            else:
                raise
