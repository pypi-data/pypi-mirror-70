...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'mongodbatlas', 'v1.1.0-alpha.1591272378+g9f10a11'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource mongodbatlas v1.1.0-alpha.1591272378+g9f10a11`
                """)
            else:
                raise
