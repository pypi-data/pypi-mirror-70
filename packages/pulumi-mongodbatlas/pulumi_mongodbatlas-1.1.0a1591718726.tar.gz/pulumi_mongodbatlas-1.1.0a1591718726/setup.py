...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'mongodbatlas', 'v1.1.0-alpha.1591718726+g7ef3bfa'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource mongodbatlas v1.1.0-alpha.1591718726+g7ef3bfa`
                """)
            else:
                raise
