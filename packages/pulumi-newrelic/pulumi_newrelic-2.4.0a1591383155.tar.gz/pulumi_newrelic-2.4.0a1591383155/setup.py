...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'newrelic', 'v2.4.0-alpha.1591383155+g36341c0'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource newrelic v2.4.0-alpha.1591383155+g36341c0`
                """)
            else:
                raise
