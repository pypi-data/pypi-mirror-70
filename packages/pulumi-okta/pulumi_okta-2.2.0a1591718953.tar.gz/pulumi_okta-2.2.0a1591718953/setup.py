...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'okta', 'v2.2.0-alpha.1591718953+g03e15ef'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource okta v2.2.0-alpha.1591718953+g03e15ef`
                """)
            else:
                raise
