...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'rabbitmq', 'v2.2.0-alpha.1591718863+g2c01b9d'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource rabbitmq v2.2.0-alpha.1591718863+g2c01b9d`
                """)
            else:
                raise
