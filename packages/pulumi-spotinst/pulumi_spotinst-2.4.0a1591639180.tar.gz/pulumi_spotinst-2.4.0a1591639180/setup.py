...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'spotinst', 'v2.4.0-alpha.1591639180+g42b406a'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource spotinst v2.4.0-alpha.1591639180+g42b406a`
                """)
            else:
                raise
