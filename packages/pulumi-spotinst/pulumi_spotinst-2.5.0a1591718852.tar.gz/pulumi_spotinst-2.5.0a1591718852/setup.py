...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'spotinst', 'v2.5.0-alpha.1591718852+gc08db1d'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource spotinst v2.5.0-alpha.1591718852+gc08db1d`
                """)
            else:
                raise
