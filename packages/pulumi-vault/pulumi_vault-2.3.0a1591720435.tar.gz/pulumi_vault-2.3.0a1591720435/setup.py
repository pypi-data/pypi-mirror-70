...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'vault', 'v2.3.0-alpha.1591720435+g1d98220'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource vault v2.3.0-alpha.1591720435+g1d98220`
                """)
            else:
                raise
