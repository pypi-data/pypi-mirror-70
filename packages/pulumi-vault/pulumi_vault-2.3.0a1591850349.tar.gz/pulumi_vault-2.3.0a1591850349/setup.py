...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'vault', '2.3.0-alpha.1591850349+70405f1a'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource vault 2.3.0-alpha.1591850349+70405f1a`
                """)
            else:
                raise
