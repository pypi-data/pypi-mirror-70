...
from pyalink.alink.utils import ensure_unicode, has_pyflink
...
def register_pyflink_function(name, func, env_type):
    if has_pyflink():
        ...
        from pyalink.alink.udf.udf import UserDefinedFunctionWrapper
    from pyalink.alink.udf.udtf import UserDefinedTableFunctionWrapper
