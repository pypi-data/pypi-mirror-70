...
class IPythonDisplayService(AbstractDisplayService):
    ...
    def __init__(self, op, key, refresh_interval, max_limit):
        ...
        from pyalink.alink.converters import schema_type_to_py_type
        ...
        self.title_display_handle = display.display("DataStream " + self.key + ": (waiting data to streaming in...)", display_id=True)
