...
setup(
  ...
  description = 'a python module to generate scrambles for most wca puzzles check github for examples. Any queries please contact midnightcuberx@gmail.com',   # Give a short description about your library
  ...
  download_url = 'https://github.com/midnightcuberx/pycubescrambler/archive/v_0.1.2.tar.gz',    # I explain this later on
