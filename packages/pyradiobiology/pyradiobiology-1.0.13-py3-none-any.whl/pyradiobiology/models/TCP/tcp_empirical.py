from pyradiobiology.models.linear_quadratic import LinearQuadratic
from pyradiobiology.primitives import Dose, DoseType, DoseArray, DoseConverter
import numpy as np
...
class TcpEmpirical():
    ...
    def _validate_doseArray_or_throw_exception(self, dose_array):
        ...
        if dose_array.dose_type != DoseType.EQD2:
