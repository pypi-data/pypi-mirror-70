...
class Converter(object):
    ...
    def sbd_median_price(self):
        """
        Obtain the sbd price as derived from the median over all witness feeds.

        Return value will be SBD
        """
        return (
    ...
    def sp_to_rshares(self, sp, voting_power=10000, vote_pct=10000):
        ...
        max_vote_denom = (
            props["vote_regeneration_per_day"] * self.config.get("STEEMIT_VOTE_REGENERATION_SECONDS") / (60 * 60 * 24)
        )
