...
class Wallet:
    """
    The wallet is meant to maintain access to private keys for your accounts. It either uses manually provided private
    keys or uses a SQLite database managed by storage.py.
    ...
    * **Force keys**: This more is for advanced users and
    ...
    def unlock(self, pwd=None):
        ...
        if self.masterpassword is None and self.configStorage[self.MasterPassword.config_key]:
            if pwd is None:
        ...
        if confirm:
            ...
            while True:
                ...
                if not pw:
                    ...
                    pwck = self.getPassword(confirm=False, text="Confirm Passphrase: ")
                    if pw == pwck:
                        return pw
                    else:
