...
API_LIST_ENDPOINT = '/api/rules/search'
API_CREATE_ENDPOINT = '/api/rules/create'
API_UPDATE_ENDPOINT = '/api/rules/update'
API_DELETE_ENDPOINT = '/api/rules/delete'
API_SHOW_ENDPOINT = '/api/rules/show'
API_REPOSITORIES_ENDPOINT = '/api/rules/repositories'
