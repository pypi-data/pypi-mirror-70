...
# Module version
version_str = "1.0.1.post321"
version_tuple = (1, 0, 1, 321)
try:
    from packaging.version import Version as V
    pversion = V("1.0.1.post321")
except ImportError:
    pass
...
# Tool version info
tool_version_str = "0.0.post56"
tool_version_tuple = (0, 0, 56)
try:
    from packaging.version import Version as V
    ptool_version = V("0.0.post56")
except ImportError:
    pass
