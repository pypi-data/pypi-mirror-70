...
class VssManager(object):
    ...
    def get_group(self, g_id):
        ...
        :return: object
        """
        json = self.request('/group/{g_id}'.format(g_id=g_id), method=self.GET)
        return json.get('data')
    ...
    def get_group_members(self, g_id):
        ...
        """
        json = self.request(
            '/group/{g_id}/member'.format(g_id=g_id), method=self.GET
        )
        return json.get('data')
    ...
    def get_vm_memory(self, vm_id):
        ...
        """
        json = self.request('/vm/{vm_id}/memory'.format(vm_id=vm_id))
        return json.get('data')
    ...
    def migrate_vm_vss_ha_group(self, vm_id):
        """
        Migrates VM from availability group from uuid to moref
        ...
        """
        json = self.request(
            '/vm/{vm_id}/vss/ha_group'.format(vm_id=vm_id), method=self.PATCH
        )
        return json.get('data')
