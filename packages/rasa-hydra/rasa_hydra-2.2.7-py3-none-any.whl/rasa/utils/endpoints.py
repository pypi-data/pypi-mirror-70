...
class EndpointConfig(object):
    ...
    def session(self):
        ...
        async def on_request_end(session, trace_config_ctx, params):
            ...
            logger.info("[{}] - Request ({}) took {}s".format(
                trace_config_ctx.trace_request_ctx["sender_id"], trace_config_ctx.trace_request_ctx["url"], elapsed)
            )
    ...
    async def request(
        ...
        **kwargs: Any
        ...
        trace_request_ctx = {"sender_id": headers["Conversation-Id"], "url": url}
