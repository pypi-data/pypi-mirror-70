...
def get_model(config, return_session=False, one_seq=False):
    ...
    [role_id_input, sequence_id_input, sequence_time_input, sequence_time_gaps_input, cross_feature_input, user_feature_input, output_mask_input, cur_time_input], model_input = input_holder.getInput(config, one_seq=one_seq)
