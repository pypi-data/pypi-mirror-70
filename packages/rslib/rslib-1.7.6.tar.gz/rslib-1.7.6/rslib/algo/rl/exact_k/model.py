...
class Generator:
    def __init__(self, l1_mask, l2_mask, l3_mask, t0_mask, t1_mask, t2_mask, t3_mask, t4_mask, l0_ssr_mask, taohua_mask, is_training=True, user=None, item_cand=None, lr=0.001, temperature=1, item_id_map=None, train_sample='random', predict_sample='random'):
        # 输入特征
        ...
        with tf.variable_scope("decoder"):
            ...
            if item_id_map is not None:
                ...
                self.custom_result_map_random = tf.transpose(tf.concat(
                    ...
                    axis=0
                ), [1, 0], name='custom_result_map_random')
