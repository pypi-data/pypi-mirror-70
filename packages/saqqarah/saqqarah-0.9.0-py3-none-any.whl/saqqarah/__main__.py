...
def main():
    ...
    subparsers = parser.add_subparsers(help='choose output mode')
    ...
    parser_img.add_argument("-f", "--filename", type= str, 
                    help="output schema (default: pyramid.png gives pyramid-puzzle.png and pyramid-solution.png)")
    ...
    parser_tikz.add_argument("-f", "--filename", type= str, default="pyramid.tex",
                    help="output name (default: pyramid.tex)")
    ...
    pyra.get_puzzle(args.difficulty,args.min, args.max, seed=args.seed)
