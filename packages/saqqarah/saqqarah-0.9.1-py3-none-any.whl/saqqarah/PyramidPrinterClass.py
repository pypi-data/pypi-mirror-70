...
class PyramidPrinter:
    """
        base class for printing pyramide
    ...
    def __init__(self, pyramide):
        ...
        self.param.size = pyramide.n
        self.param.n_values = pyramide.n_lines
        self.param.pyramid_puzzle = pyramide.puzzle
        self.param.pyramid_solution  = pyramide.solution
    ...
    def print(self, **kwargs):
        ...
        if puzzle and not self.param.pyramid_puzzle:
            puzzle = False
        if solution and self.param.pyramid_solution is None:
            solution = False
