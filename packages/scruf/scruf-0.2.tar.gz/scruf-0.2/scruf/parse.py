...
class Parser:
    ...
    def __init__(self, indent="    "):
        ...
        self._content_getter = {
            ...
            self.fsm.States.COMMAND: self.tokeniser.get_command,
    ...
    def _test_to_test_object(self, raw_test):
        command = " ".join(
            raw_test[self.fsm.States.COMMAND] + raw_test[self.fsm.States.CONTINUE]
        )
    ...
    def __init__(self, tokeniser):
        ...
        self.progressions = {
            self.States.START: {
                ...
                self.States.COMMAND: self.tokeniser.is_command,
            },
            ...
            self.States.COMMAND: {
                ...
                or self.tokeniser.is_command(line),
            },
