...
class RestoreMonitorUseCase(RestoreUseCase):
    def __init__(self, monitor: SdMonitorClient, repository, formatter=yaml.safe_load):
        self._monitor = monitor
        super().__init__(repository, formatter)


class RestoreSecureUseCase(RestoreUseCase):
    def __init__(self, secure: SdSecureClient, repository, formatter=yaml.safe_load):
        self._secure = secure
        super().__init__(repository, formatter)
...
class RemoveSecureUseCase(RemoveUseCase):
    def __init__(self, secure: SdSecureClient):
        self._secure = secure
