...
@LastEditTime: 2020-06-05 16:18:16
...
class BaseModel:
    ...
    def del_entity(self, where, params=None):
        ...
        if where:
            ...
            if self.is_transaction():
                ...
                self.transaction_sql_list.append(transaction_item)
                return True
            else:
    ...
    def commit_transaction(self):
        ...
        @last_editors: ChenXiaolei
        """
        if not hasattr(self, "is_transaction") or self.is_transaction != True or not hasattr(self, "transaction_sql_list") or not self.transaction_sql_list or len(self.transaction_sql_list) == 0:
            return False

        delattr(self, "is_transaction")
        delattr(self, "transaction_sql_list")

        return self.transaction_execute(self.transaction_sql_list)
    ...
    def is_transaction(self):
        if hasattr(self, "is_transaction") and self.is_transaction == True:
            return True
        return False
