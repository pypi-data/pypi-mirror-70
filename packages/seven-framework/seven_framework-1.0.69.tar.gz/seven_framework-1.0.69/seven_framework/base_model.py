...
@LastEditTime: 2020-06-08 12:48:49
...
class BaseModel:
    ...
    def del_entity(self, where, params=None):
        ...
        if where:
            ...
            if self.is_transaction():
                ...
                self._transaction_sql_list.append(transaction_item)
                return True
            else:
    ...
    def commit_transaction(self):
        ...
        @last_editors: ChenXiaolei
        """
        if not hasattr(self, "_is_transaction") or self._is_transaction != True or not hasattr(self, "_transaction_sql_list") or not self._transaction_sql_list or len(self._transaction_sql_list) == 0:
            return False

        sql_list = self._transaction_sql_list
        
        delattr(self, "_is_transaction")
        delattr(self, "_transaction_sql_list")
    ...
    def is_transaction(self):
        if hasattr(self, "_is_transaction") and self._is_transaction == True:
            return True
        return False
