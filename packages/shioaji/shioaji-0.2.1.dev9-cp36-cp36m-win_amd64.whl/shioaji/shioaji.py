    ...
    def __init__(
        ...
        if simulation:
            self._solace = SolaceAPI(
                config.SJCLIENT_SOL_HOST_SIM,
                config.SJCLIENT_SOL_VPN_SIM,
                config.SJCLIENT_SOL_USER_SIM,
                config.SJCLIENT_SOL_PASSWORD_SIM,
                simulation,
                proxies,
            )
            from shioaji.backend.solace.utils import mockca     
