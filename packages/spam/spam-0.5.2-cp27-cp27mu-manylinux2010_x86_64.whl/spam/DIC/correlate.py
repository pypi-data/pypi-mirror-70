...
def register(im1, im2, im1mask=None, PhiInit=None, PhiInitBinRatio=1.0, margin=None, maxIterations=25, deltaPhiMin=0.001, interpolationOrder=1, interpolator='python', verbose=False, imShowProgress=None, imShowProgressNewFig=False):
    """
    ...
    while iterationNumber < maxIterations and deltaPhiNorm > deltaPhiMin:
        ...
        # On first iteration, compute hessian and jacobian
...
def registerMultiscale( im1, im2, binMax, PhiInit=None, PhiInitBinRatio=1.0, margin=None, maxIterations=100, deltaPhiMin=0.0001, interpolationOrder=1, interpolator='C', verbose=False, imShowProgress=None):
    """
