...
def spintop_api_module(auth_module, integration_config):
    if not integration_config:
        ...
        env = SpintopEnv(api_url=integration_config.spintop_api_url, org_id=integration_config.expected_org)
        return env.spintop_factory(auth_factory=lambda: auth_module)
