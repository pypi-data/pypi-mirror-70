...
@run_async
def update_usernames(context: CallbackContext):
    ...
    for u_id in tg_users:
        try:
            user = context.bot.get_chat_member(chat_id=-1001103155670, user_id=u_id).user
...
if __name__ == '__main__':
    ...
    update_users_job = job_queue.run_repeating(update_usernames, interval=3600, first=0)
