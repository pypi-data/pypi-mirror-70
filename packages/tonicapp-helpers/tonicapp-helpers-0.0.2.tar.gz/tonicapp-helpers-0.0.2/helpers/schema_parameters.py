...
schema_locale = [
    OpenApiParameter(
        ...
        location=OpenApiParameter.QUERY,
        description=f'Filter by one or multiple locales. Example: locale=pt-PT or locale[in]=pt-PT , es-ES. The space before and after the comma is necessary. {desc_available_operators_in}',
        required=False,
        type=OpenApiTypes.STR
    ),
]
