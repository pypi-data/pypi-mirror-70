...
def NLP_analysis(data, keyword_corpus, hashtag_corpus):
    ...
    if len(tweets_df[tweets_df["terrorist_suggestion"]==1]) == 0:
      ...
      tweets_df["terrorist_suggestion"][(tweets_df["terrorist_suggestion"]==1) & (tweets_df["polarity"] < 0.1) & (tweets_df["subjectivity"]>0.2) & (tweets_df["polarity"] > -0.1) & (tweets_df["subjectivity"]<0.4)]= 4
