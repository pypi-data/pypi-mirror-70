...
def more_tweets_required(df,df_graph_features,consumerKey,consumerSecret,accessToken,accessTokenSecret,n_groups,save_by,ruta_fichero,nombreFichero):
	...
	if len(node_list_moreData) >0:
		df_metadata_moreData, list_more_Data_noData = user_timeline_extraction(node_list_moreData,consumerKey,consumerSecret,accessToken,accessTokenSecret,n_groups,save_by,ruta_fichero, nombreFichero)
		df_metadata_moreData = pd.read_csv(ruta_fichero + nombrefichero)
