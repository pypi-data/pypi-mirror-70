...
class StorageClient(object):
    ...
    def storage_to_bigquery(self, objects: list, table_ref, write_disposition, batch_size=5000):
        ...
        self.__rec_compose(blobs=blobs, blob_name=blob_base_name, table_ref=table_ref, write_disposition=write_disposition)
    ...
    def single_storage_to_bigquery(self, object, table_ref, write_disposition, batch_size=500):
        ...
        if len(blobs) > batch_size:
            self.__rec_compose(blobs=blobs, blob_name=f'{object_name}_{generate_random_string()}',table_ref=table_ref, write_disposition=write_disposition)
