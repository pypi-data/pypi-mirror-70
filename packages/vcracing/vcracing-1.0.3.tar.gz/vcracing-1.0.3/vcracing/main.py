...
class vcracing():
    def __init__(self, track_seed=None, verbose=0, car='BT46', track_len=200):
        ...
        if car == 'avro' or car == 'AVRO' or car == 'Avro':
            self.carimg = Image.open('data/top_avro.png').convert('RGBA'); self.carimg.close
        elif car == 'BT46' or car == 'bt46' or car == 'BT' or car == 'bt':
            self.carimg = Image.open('data/top_BT46.png').convert('RGBA'); self.carimg.close
        elif car == 'P34' or car == 'p34' or car == 'P' or car == 'p':
            self.carimg = Image.open('data/top_P34.png').convert('RGBA'); self.carimg.close
        elif car == 'novgorod' or car == 'NOVGOROD' or car == 'Novgorod':
            self.carimg = Image.open('data/top_novgorod.png').convert('RGBA'); self.carimg.close
        elif car == 'twinturbo' or car == 'TWINTURBO' or car == 'Twinturbo':
            self.carimg = Image.open('data/top_twinturbo.png').convert('RGBA'); self.carimg.close
        else:
            self.carimg = Image.open('data/top_BT46.png').convert('RGBA'); self.carimg.close
