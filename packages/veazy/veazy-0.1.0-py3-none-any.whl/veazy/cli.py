...
@click.option('-r', '--root-file', type=click.Path(exists=True, resolve_path=True), help='A top-level entry from where relative depth is determined.')
...
@click.option('-c', '--complexity-offset', type=int, default=0, help='To adjust the automatic depth. When depth is passed, this value is ignored.')
