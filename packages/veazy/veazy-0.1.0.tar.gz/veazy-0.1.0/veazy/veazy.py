...
class Veazy:
    ...
    def _fill_depth_of_nodes(self):
        ...
        # TODO: add check of source file
        # TODO: maybe list all py files in root dir? And let choose?
        ...
        # TODO: identify functions that are not top node but also not called by top node
        missing_depths = {}
        for node in self.node_list:
            if node not in self.depth_of_nodes.keys():
                ...
                if node in self.script_nodes:
                    ...
                    # This is a bit hacky, I want these to be summarized in any case
                    missing_depths[node] = 100000
    ...
    def _add_summarizing(self, max_depth):
        ...
        # TODO: use '.' as separator instead of '__'
        ...
        for node in summarizing_nodes:
            if node != "":
                ...
                # TODO: add 'other' to summarizing node name
    ...
    def prune_depth(self, max_depth):
        return self.get_pruned_graph(max_depth)
