...
class Cluster(object):
    ...
    def performer_key(self, performer_key):
        ...
        if (self.local_vars_configuration.client_side_validation and
                performer_key is not None and len(performer_key) > 256):
            raise ValueError("Invalid value for `performer_key`, length must be less than or equal to `256`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
    ...
    def representer_key(self, representer_key):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                representer_key is not None and len(representer_key) > 256):
            raise ValueError("Invalid value for `representer_key`, length must be less than or equal to `256`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
