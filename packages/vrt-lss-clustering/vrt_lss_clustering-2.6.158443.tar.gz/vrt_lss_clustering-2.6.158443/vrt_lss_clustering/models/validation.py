...
class Validation(object):
    ...
    def entity_key(self, entity_key):
        ...
        if (self.local_vars_configuration.client_side_validation and
                entity_key is not None and len(entity_key) > 256):
            raise ValueError("Invalid value for `entity_key`, length must be less than or equal to `256`")  # noqa: E501
    ...
    def entity_type(self, entity_type):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                entity_type is not None and len(entity_type) > 256):
            raise ValueError("Invalid value for `entity_type`, length must be less than or equal to `256`")  # noqa: E501
