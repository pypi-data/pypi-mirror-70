...
"""
    ...
    The version of the OpenAPI document: 2.6.158370
...
class Shift(object):
    ...
    def resource_key(self, resource_key):
        ...
        if (self.local_vars_configuration.client_side_validation and
                resource_key is not None and len(resource_key) > 100):
            raise ValueError("Invalid value for `resource_key`, length must be less than or equal to `100`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
    ...
    def start_location_key(self, start_location_key):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                start_location_key is not None and len(start_location_key) > 100):
            raise ValueError("Invalid value for `start_location_key`, length must be less than or equal to `100`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
    ...
    def finish_location_key(self, finish_location_key):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                finish_location_key is not None and len(finish_location_key) > 100):
            raise ValueError("Invalid value for `finish_location_key`, length must be less than or equal to `100`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
