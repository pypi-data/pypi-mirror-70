...
class Shift(object):
    ...
    def start_location_key(self, start_location_key):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                start_location_key is not None and len(start_location_key) > 256):
            raise ValueError("Invalid value for `start_location_key`, length must be less than or equal to `256`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
    ...
    def finish_location_key(self, finish_location_key):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                finish_location_key is not None and len(finish_location_key) > 256):
            raise ValueError("Invalid value for `finish_location_key`, length must be less than or equal to `256`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
