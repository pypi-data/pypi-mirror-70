...
class Order(object):
    ...
    def trip_short_key(self, trip_short_key):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                trip_short_key is not None and len(trip_short_key) > 100):
            raise ValueError("Invalid value for `trip_short_key`, length must be less than or equal to `100`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
