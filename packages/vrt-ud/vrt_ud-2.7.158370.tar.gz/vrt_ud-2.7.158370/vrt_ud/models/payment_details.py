...
class PaymentDetails(object):
    ...
    def bill_number_in_shift(self, bill_number_in_shift):
        ...
        if (self.local_vars_configuration.client_side_validation and
                bill_number_in_shift is not None and len(bill_number_in_shift) > 100):
            raise ValueError("Invalid value for `bill_number_in_shift`, length must be less than or equal to `100`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
    ...
    def bill_date_time(self, bill_date_time):
        ...
        if (self.local_vars_configuration.client_side_validation and
                bill_date_time is not None and len(bill_date_time) > 100):
            raise ValueError("Invalid value for `bill_date_time`, length must be less than or equal to `100`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
    ...
    def fd_number(self, fd_number):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                fd_number is not None and len(fd_number) > 100):
            raise ValueError("Invalid value for `fd_number`, length must be less than or equal to `100`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
    ...
    def fn_number(self, fn_number):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                fn_number is not None and len(fn_number) > 100):
            raise ValueError("Invalid value for `fn_number`, length must be less than or equal to `100`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
    ...
    def payment_type(self, payment_type):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                payment_type is not None and len(payment_type) > 100):
            raise ValueError("Invalid value for `payment_type`, length must be less than or equal to `100`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
    ...
    def approval_code(self, approval_code):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                approval_code is not None and len(approval_code) > 100):
            raise ValueError("Invalid value for `approval_code`, length must be less than or equal to `100`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
    ...
    def kkt_registration_number(self, kkt_registration_number):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                kkt_registration_number is not None and len(kkt_registration_number) > 100):
            raise ValueError("Invalid value for `kkt_registration_number`, length must be less than or equal to `100`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
