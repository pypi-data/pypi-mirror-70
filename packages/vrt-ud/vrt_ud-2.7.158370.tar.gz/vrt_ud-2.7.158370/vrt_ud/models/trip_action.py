...
class TripAction(object):
    ...
    def order_key(self, order_key):
        ...
        if (self.local_vars_configuration.client_side_validation and
                order_key is not None and len(order_key) > 100):
            raise ValueError("Invalid value for `order_key`, length must be less than or equal to `100`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
    ...
    def location_key(self, location_key):
        ...
        if (self.local_vars_configuration.client_side_validation and
                location_key is not None and len(location_key) > 100):
            raise ValueError("Invalid value for `location_key`, length must be less than or equal to `100`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
