...
class CargoPlacement(object):
    ...
    def box_key(self, box_key):
        ...
        if (self.local_vars_configuration.client_side_validation and
                box_key is not None and len(box_key) > 256):
            raise ValueError("Invalid value for `box_key`, length must be less than or equal to `256`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
    ...
    def cargo_key(self, cargo_key):
        ...
        if (self.local_vars_configuration.client_side_validation and
                cargo_key is not None and len(cargo_key) > 256):
            raise ValueError("Invalid value for `cargo_key`, length must be less than or equal to `256`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
