...
def setup_yams_object(command):
    ...
    commands['list'].add_argument('--show-recoverable', action='store_true', help="the list will contain which objects has been deleted and are recoverable")
    commands['list'].add_argument('--list-backup', action='store_true', help="the list will contain objects from the backup bucket")
